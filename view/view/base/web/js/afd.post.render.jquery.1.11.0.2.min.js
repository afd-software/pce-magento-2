!(function (t, e) {
  ...
  var e = {
    ...
    typeahead: {
      ...
      providerInfo: !1,
      wThreeWMode: 2,
      wThreeWReverseGeocode: !1,
      wThreeWDistanceUnit: 'M',
  ...
  var p = jQuery,
    f = r(function t(e, i) {
      ...
      if (
        ...
        h(this, 'setupParams', function (t) {
          var e = { format: 'json' }
          if (o.options.serial && o.options.password)
            (e.serial = o.options.serial), (e.password = o.options.password)
          else {
            if (!o.options.token || !o.options.id)
              throw 'You must either supply password and serial, or token and id'
            ;(e.token = o.options.token), (e.id = o.options.id)
          }
          ;(e.intf = 'jqu011100'),
            o.options.platformVersion && (e.intp = o.options.platformVersion),
            o.options.defaultCountry &&
              (e.countryiso = o.options.defaultCountry),
            o.options.country.defaultCountry &&
              (e.countryiso = o.options.country.defaultCountry),
            o.$container || (o.$container = p(document))
          var n = o.$container.find(p('[data-afd-control="country"]'))
          if (
            (n.length > 0 &&
              'country' !== o.$element.attr('data-afd-control') &&
              (e.countryiso =
                'SELECT' === n.prop('tagName')
                  ? n.val()
                  : o.iso2ToIso3(
                      n
            ...
            o.$afdCountryCodeField &&
              void 0 !== o.$afdCountryCodeField &&
              o.$afdCountryCodeField.length > 0 &&
              (e.countryiso = o.$afdCountryCodeField.val()),
            o.options.country.customCountryControl)
          ) {
            var i =
              0 === p(o.options.typeahead.containers.toString()).length
                ? p(o.options.country.customCountryControl)
                : o.$element
                    .closest(o.options.typeahead.containers.toString())
                    .find(o.options.country.customCountryControl)
            if (o.options.country.customCountryConverter) {
              if ('function' != typeof o.options.country.customCountryConverter)
                throw 'customCountryConverter Must be a function'
              e.countryiso = o.options.country.customCountryConverter(i.val())
            } else e.countryiso = i.val()
          }
          try {
            return {
              method: 'GET',
              url: o.options.pceUrl,
              error: function (t, e, n) {
                console.error(t),
                  console.error(e),
                  console.error(n),
                  p(document).trigger('afd:pceError', t)
              },
              data: p.extend(!0, {}, e, t),
              callback:
                void 0 !== o.requestCallback
                  ? { done: o.requestCallback }
                  : null,
              beforeSend: void 0 !== o.beforeSend ? o.beforeSend : null
            }
          } catch (t) {
            console.error('Error setting up request'), console.error(t)
          }
        }),
        h(this, 'eventHandler', function (t, e, n) {
          t.off(e + '.afd' + o.controlID).on(e + '.afd' + o.controlID, n)
        }),
        h(this, 'handlePCEError', function (t, e) {
          '1' !== t && console.error(e)
        }),
        h(this, 'iso2ToIso3', function (t) {
          return o.countryCodeMap[t.toUpperCase()] || null
        }),
        h(this, 'iso3ToIso2', function (t) {
          return (
            (t &&
              Object.keys(o.countryCodeMap).find(function (e) {
                return o.countryCodeMap[e] === t.toUpperCase()
              })) ||
            null
          )
        }),
        ...
        void 0 === this.$element.data('afd-control-id') &&
          this.$element.data(
            'afd-control-id',
            Math.random().toString().slice(2, 11)
          ),
        (this.controlID = this.$element.data('afd-control-id')),
        void 0 !== e.data('afd-additional-options'))
      ) {
        var a = window[e.data('afd-additional-options')]
        ;(a = void 0 === a ? e.data('afdAdditionalOptions') : a),
          (this.options = p.extend(!0, {}, i, a))
      } else this.options = i
    })
  function v(t, e) {
  ...
  var b = function (t, e) {
    ...
    w = Array.isArray,
    k = 'object' == typeof y && y && y.Object === Object && y,
    S = k,
    I = 'object' == typeof self && self && self.Object === Object && self,
    L = S || I || Function('return this')(),
    x = L.Symbol,
    _ = x,
    M = Object.prototype,
    A = M.hasOwnProperty,
  ...
  var D = function (t) {
    ...
    N = D
  var j = function (t) {
      return 'symbol' == typeof t || (N(t) && '[object Symbol]' == V(t))
    },
    G = w,
    U = j,
    q = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
  ...
  var J,
    ...
    tt = (J = /[^.]+$/.exec((X && X.keys && X.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + J
      : ''
  var et = function (t) {
      return !!tt && tt in t
  ...
  var ft = function (t) {
      return !(!rt(t) || at(t)) && (ot(t) ? pt : lt).test(st(t))
    },
    vt = function (t, e) {
  ...
  var _t = Ct,
    ...
    Et = function (t) {
      var e = this.__data__
      return It ? void 0 !== e[t] : Lt.call(e, t)
    },
    Ft = function (t, e) {
      var n = this.__data__
      return (
        (this.size += this.has(t) ? 0 : 1),
        (n[t] = xt && void 0 === e ? '__lodash_hash_undefined__' : e),
        this
      )
    }
  function Ot(t) {
  ...
  ;(Ot.prototype.clear = _t),
    (Ot.prototype.delete = Mt),
    (Ot.prototype.get = At),
    (Ot.prototype.has = Et),
    (Ot.prototype.set = Ft)
  var Rt = Ot
  ...
  ;(Wt.prototype.clear = Gt),
    (Wt.prototype.delete = Ut),
    (Wt.prototype.get = qt),
    (Wt.prototype.has = Ht),
    (Wt.prototype.set = Kt)
  var Zt = Wt,
  ...
  ;(de.prototype.clear = re),
    (de.prototype.delete = se),
    (de.prototype.get = le),
    (de.prototype.has = ue),
    (de.prototype.set = ce)
  var he = de,
  ...
  function fe(t, e) {
    ...
    return (n.cache = new (fe.Cache || pe)()), n
  }
  fe.Cache = pe
  var ve = fe
  var ge =
  ...
  var Ce = function (t, e) {
    ...
    be = w,
    we = j,
    ke = x ? x.prototype : void 0,
    Se = ke ? ke.toString : void 0
  var Ie = function t(e) {
      if ('string' == typeof e) return e
      if (be(e)) return Ce(e, t) + ''
      if (we(e)) return Se ? Se.call(e) : ''
      var n = e + ''
  ...
  var Ee = function (t, e) {
      return xe(t) ? t : _e(t, e) ? [t] : Me(Ae(t))
    },
    Fe = P,
    Oe = D
  var Re = function (t) {
      return Oe(t) && '[object Arguments]' == Fe(t)
    },
    ze = D,
    $e = Object.prototype,
    Te = $e.hasOwnProperty,
    Be = $e.propertyIsEnumerable,
    Pe = Re(
      (function () {
        return arguments
      })()
      ...
      ? Re
      : function (t) {
          return ze(t) && Te.call(t, 'callee') && !Be.call(t, 'callee')
        },
    De = Pe,
    Ve = /^(?:0|[1-9]\d*)$/
  var Ne = function (t, e) {
  ...
  var je = function (t) {
    ...
    Ge = j
  var Ue = function (t) {
      if ('string' == typeof t || Ge(t)) return t
      var e = t + ''
  ...
  var Je = function (t, e, n) {
      for (var i = -1, o = (e = qe(e, t)).length, a = !1; ++i < o; ) {
        var r = Qe(e[i])
        if (!(a = null != t && n(t, r))) break
        t = t[r]
      }
      return a || ++i != o
        ? a
    ...
    Ye = b,
    Xe = Je
  var tn = m(function (t, e) {
      return null != t && Xe(t, e, Ye)
    }),
    en = Ee,
    nn = Ue
  var on = function (t, e) {
  ...
  !(function (t) {
    var e,
      ...
      r = !n || ((e = new n()).append('s', ' &'), 's=+%26' === e.toString()),
      s = d.prototype,
    ...
    if (!(n && i && o && r)) {
      ;(s.append = function (t, e) {
        ...
        (s.toString = function () {
          var t,
            ...
            r = []
          for (e in o)
            for (n = h(e), t = 0, i = o[e]; t < i.length; t++)
              r.push(n + '=' + h(i[t]))
          return r.join('&')
        })
      var u = !!o && n && !i && t.Proxy
      ...
      ;(c.polyfill = !0),
        ...
        l && (c[t.Symbol.iterator] = c[t.Symbol.iterator] || c.entries)
    }
    function d(t) {
      ...
      if ('object' == typeof t)
        ...
        for (var a = t.split('&'), r = 0; r < a.length; r++) {
          var s = a[r],
            l = s.indexOf('=')
          ;-1 < l
            ? g(e, p(s.slice(0, l)), p(s.slice(l + 1)))
            : s && g(e, p(s), '')
        }
      }
      return e
  ...
  })(void 0 !== y ? y : 'undefined' != typeof window ? window : y)
  var un = jQuery,
    cn = function (t) {
      return (function (t) {
        u(i, t)
        ...
        function i(t, o) {
          ...
          return (
            n(this, i),
            h(s((a = e.call(this, t, o))), 'initRequestSequence', function () {
              ;(a.seq = 0), (a.lastSeq = 0)
            }),
            h(s(a), 'beforeSend', function (t, e) {
              var n = new URLSearchParams(e.url)
              ;(t.lookup = n.get('lookup')),
                (t.seq = a.seq),
                a.seq++,
                un(document).trigger('afd:pceLookupStarted', [
                  t,
                  n.get('lookup')
                ])
            }),
            h(s(a), 'requestCallback', function (t, e, n) {
              ;(a.wThreeW =
                void 0 !== t.W3W ||
                (void 0 !== t.Suggestion && 'What3Words' === t.Suggestion)),
                un(document).trigger('afd:pceLookupComplete', [t, n, n.lookup])
            }),
            h(s(a), 'getUniqueID', function () {
              return Math.floor(9e4 * Math.random()) + 1e4
            }),
            h(s(a), 'setFields', function () {
              'init' === a.options[a.controlType].wThreeWReverseGeocode &&
                navigator.geolocation.getCurrentPosition(
                  a.onGeolocationSuccess,
                  a.onGeolocationError
                )
              var t = a.options[a.controlType].linkedControl
                ? a.options[a.controlType].linkedControl
                : a.controlType
              a.containers = a.options[t].containers.toString()
              var e =
                a.$element.closest(a.containers).length > 0
                  ? a.$element.closest(a.containers)
                  : un(document)
              ;(a.$container = e),
                (a.$typeaheadFieldandLabel = sn(
                  a.options,
                  t + '.containerOnlyContainsControl',
                  !1
                )
                  ? e.find('.afd-typeahead-container')
                  : e.find(
                      '.afd-typeahead-container > label, .afd-typeahead-field'
                    )),
                (a.$typeAheadInput = e.find('.afd-typeahead-container input')),
                (a.$resultFields = e.find('[data-afd-result]')),
                (a.$typeaheadContainer = e.find('.afd-typeahead-container')),
                (a.$errorField = e.find('.afd-' + t + '-error')),
                (a.$manualInputButton = tn(
                  a.options,
                  t + '.manualInputButtonIdentifier'
                )
                  ? e.find(a.options[t].manualInputButtonIdentifier)
                  : e.find('.afd-manual-input-button')),
                (a.$manualInputSearchButton = tn(
                  a.options,
                  t + '.manualInputSearchButtonIdentifier'
                )
                  ? e.find(a.options[t].manualInputSearchButtonIdentifier)
                  : e.find('.afd-manual-input-search-button')),
                (a.$searchAgainButton = tn(
                  a.options,
                  t + '.searchAgainButtonIdentifier'
                )
                  ? e.find(a.options[t].searchAgainButtonIdentifier)
                  : e.find('.afd-search-again')),
                (a.$fieldSets = e.find(a.options[t].fieldSets.toString()))
              var n =
                void 0 !== a.originalControlType ? a.originalControlType : t
              if (
                ((a.$afdCountryField =
                  e.find('[data-afd-control="country"]').length > 0
                    ? e
                        .find('[data-afd-control="country"]')
                        .off('change.afd' + n)
                        .on('change.afd' + n, a.onAfdCountryChange)
                    : null),
                (a.$customCountryField =
                  e.find(a.options.country.customCountryControl).length > 0
                    ? e
                        .find(a.options.country.customCountryControl)
                        .off('change.afd' + n)
                        .on('change.afd' + n, a.onCustomCountryChange)
                    : null),
                (a.multiForms = un(a.containers).length > 0),
                a.$customCountryField && 0 === a.$customCountryField.length)
              )
                throw (
                  'Custom country field selector `' +
                  a.options.country.customCountryControl +
                  '` supplied, but no matching control found.'
                )
              a.parentSelector = a.options[t].parentClass
                ? '.' === a.options[t].parentClass.charAt(0)
                  ? a.options[t].parentClass
                  : '.' + a.options[t].parentClass
                : null
            }),
            h(s(a), 'initFields', function () {
              var t = a.controlType
              a.$typeaheadFieldandLabel.show()
              var e = a.options[t].fieldSets,
                n = a.getInitialCountry()
              if (a.options[t].beforeHideResults) {
                if (
                  (a.$manualInputSearchButton.hide(),
                  a.hideResultFields(n),
                  e.length > 0)
                )
                  for (var i = 0; i < e.length; i++) un(e[i]).hide()
                if (a.options[t].notEmptyShowResults)
                  0 ===
                    a.$container
                      .find('[data-afd-result]:empty')
                      .filter(function () {
                        return 0 !== un.trim(un(this).val()).length
                      }).length ||
                    (a.showResultFields(),
                    a.$fieldSets.show(),
                    a.$manualInputButton.hide())
              } else if ((a.showResultFields(), e.length > 0))
                for (var o = 0; o < e.length; o++) un(e[o]).show()
            }),
            h(s(a), 'addressLookup', function (t) {
              var e = a.controlType,
                n = {
                  data: 'address',
                  task: 'fastfindv4',
                  fields: a.options[e].postcodeFirst ? 'list' : 'fflist',
                  uniqueid: a.uniqueID,
                  lookup: t,
                  allpc: '1'
                }
              a.options[e].listEnv && (n.listEnv = '1'),
                a.position &&
                  ((n.longitude = a.position.coords.longitude),
                  (n.latitude = a.position.coords.latitude)),
                a.options[e].bankLookup &&
                  ((n.data = 'bank'),
                  (n.task = 'fastfind'),
                  (n.clearing = 'all')),
                un.extend(n, a.options[e].extraPCESearchParams)
              var i = a.setupParams(n)
              return 1 === a.options.afdc && (i.data.afdc = 1), un.ajax(i)
            }),
            h(s(a), 'addressRetrieve', function (t) {
              var e = {
                key: t,
                data: 'address',
                task: 'retrieve',
                fields: a.options[a.controlType].retrieveFields
              }
              a.options[a.controlType].flatSubBuild && (e.flatSubBuild = '1'),
                a.options[a.controlType].bankLookup &&
                  ((e.data = 'bank'),
                  (e.clearing = 'all'),
                  (e.task = 'retrieve'),
                  (e.fields = 'standard')),
                a.options[a.controlType].listEnv && (e.listEnv = '1'),
                un.extend(e, a.options[a.controlType].extraPCERetrieveParams)
              var n = a.setupParams(e)
              return 1 === a.options.afdc && (n.data.afdc = 1), un.ajax(n)
            }),
            h(s(a), 'reverseGeocodeLookup', function (t) {
              var e = a.controlType,
                n = a.setupParams({
                  data: 'address',
                  task: 'nearest',
            ...
            h(s(a), 'handleAddressRetrieve', function (t, e) {
              var n = a.controlType
              if (void 0 !== t.Item) {
                var i = g(t.Item, 1)
                ;(a.result = i[0]),
                  un(document).trigger('afd:pceRetrieveComplete', [
                    a.result,
                    e
                  ]),
                  a.$element.trigger('afd:pceRetrieveComplete', [a.result, e]),
                  a.$manualInputButton.hide(),
                  a.options[n].afterClearTypeahead && a.$typeAheadInput.val(''),
                  a.options[n].afterHideTypeahead &&
                    a.$typeaheadFieldandLabel.hide(),
                  a.options[n].afterHideButtonAndFields &&
                    (a.$container
                      .find('[data-afd-control="reverseGeocodeButton"]')
                      .hide(),
                    a.$container
                      .find('[data-afd-control="lookupButton"]')
                      .hide(),
                    a.$container
                      .find('[data-afd-control="lookupField"]')
                      .hide()),
                  a.options[n].searchAgain && a.$searchAgainButton.show(),
                  a.$fieldSets.show(),
                  a.$resultFields.length < 1 ||
                    (a.$resultFields.each(a.populateResult),
                    un(document).trigger('afd:populateResultsComplete', [
                      a.$element,
                      a.$container,
                      a.result
                    ]),
                    a.$typeAheadInput.blur())
              }
            }),
            h(s(a), 'populateResult', function (t) {
              var e = un(a.$resultFields[t]),
                n = e.data('afd-result')
              e.val('')
              var i = a.options[a.controlType].linkedControl
                ? a.options[a.controlType].linkedControl
                : a.controlType
              if (
                [
                ...
                a.options[i].regionMap &&
                e.is('select')
              ) {
                var o = a.options[i].regionAttribute
                a.result[n]
                var r = a.options[i].regionMap(a.result),
                  s = e.find('[' + o + '="' + r + '"]').val()
                return (
                  e.val(s), e.closest(a.parentSelector).show(), void e.show()
                )
              }
              a.options[i].pushUp
                ? Array.isArray(a.options[i].pushUp)
                  ? a.handlePushUp(a.options[i].pushUp, n, e)
                  : a.handlePushUp(['Property', 'Street', 'Locality'], n, e)
                : a.setResultValue(e, n),
                !a.options[i].hideEmpties ||
                (e.val() && e.val().length > 0) ||
                e.is('[required]') ||
                e.is(a.options[i].requiredSelector) ||
                e.closest(a.parentSelector).is(a.options[i].requiredSelector)
                  ? a.parentSelector
                    ? e.closest(a.parentSelector).show()
                    : e.show()
                  : a.parentSelector
                    ? e.closest(a.parentSelector).hide()
                    : e.hide(),
                a.$fieldSets.show(),
                e.triggerHandler('keyup'),
                e.triggerHandler('change'),
                un(document).trigger('afd:populateResultComplete', [
                  n,
                  a.$element,
                  a.$container,
                  a.result
            ...
            h(s(a), 'setResultValue', function (t, e) {
              t.val(''),
                e.indexOf(',') > -1
                  ? e.split(',').forEach(function (e, n) {
                      0 !== n &&
                        ...
                        t.val().length > 0 &&
                        t.val(t.val() + ', '),
                        t.val(t.val() + a.result[e])
                    })
                  : t.val(a.result[e]),
                t.val()
            }),
            h(s(a), 'populateResultsList', function () {
              if (1 !== a.results.length) {
                var t =
                  'SELECT' === a.$resultList.prop('tagName') ? 'option' : 'li'
                a.$resultList.empty(),
                  'option' === t &&
                    void 0 === a.$resultList.attr('multiple') &&
                    a.$resultList.append(
                      '<option value="null">' +
                        a.options.lookup.selectAddressText +
                        '</option>'
                    ),
                  0 === a.results.length &&
                    a.$resultList.append(
                      '<' +
                        t +
                        ' value="null">' +
                        a.options.lookup.noResultsText +
                        '</' +
                        t +
                        '>'
                    )
                for (var e = 0; e < a.results.length; e++) {
                  var n = a.results[e]
                  a.$resultList.append(
                    '<' +
                      t +
                ...
                'li' === t &&
                  ((a.$resultListResults = a.$resultList.children('li')),
                  a.eventHandler(
                    a.$resultListResults,
                    'click',
                    a.onResultListItemClick
                  )),
                  a.$resultList.show().closest('.afd-form-control').show(),
                  a.$resultList.focus()
              } else a.selectResult(a.results[0].Key)
            }),
            h(s(a), 'onResultListItemClick', function (t) {
              a.selectResult(un(t.target).attr('value'))
            }),
            h(s(a), 'onKeyDownResult', function (t) {
              var e = t.keyCode ? t.keyCode : t.which
              13 === e && t.preventDefault(),
                [38, 40].indexOf(e) > -1 && (a.blockChange = !0)
            }),
            h(s(a), 'onKeyUpResult', function (t) {
              13 === (t.keyCode ? t.keyCode : t.which) &&
                a.selectResult(t.target.value)
            }),
            h(s(a), 'onChangeResult', function (t) {
              a.blockChange || a.selectResult(t.target.value),
                (a.blockChange = !1)
            }),
            h(s(a), 'selectResult', function (t) {
              ;(a.options[a.controlType].afterRetrieveHideResultsList ||
                a.isReverseGeocode) &&
                a.hideResultsElement(),
                'null' === t && a.onAfdManualInputButtonClick(),
                a
                  .addressRetrieve(t)
                  .then(function (t, e, n) {
                    a.handleAddressRetrieve(t, n)
                  })
                  .fail(function (t) {
                    throw t
                  })
            }),
            h(s(a), 'hideResultsElement', function () {
              a.$resultList.closest('.afd-form-control').hide()
            }),
            h(s(a), 'hideResultFields', function (t) {
              var e = a.controlType
              if (
                !(
                  a.options[e].showForCountries.length > 0 ||
                  a.options[e].hideForCountries.length > 0
                ) ||
                (a.options[e].showForCountries.length > 0 &&
                  a.options[e].showForCountries.indexOf(t) > -1) ||
                (a.options[e].length > 0 &&
                  -1 === a.options[e].hideForCountries.indexOf(t))
              ) {
                if (
                  (a.parentSelector
                    ? a.$resultFields.closest(a.parentSelector).hide()
                    : a.$resultFields.hide(),
                  a.$fieldSets.hide(),
                  a.options[e].notEmptyShowResults)
                )
                  0 ===
                    a.$container
                      .find('[data-afd-result]:empty')
                    ...
                    a.$fieldSets.show(),
                    a.$manualInputButton.hide())
                sn(a.options, e + '.postcodeIsLookup', !1) &&
                  (a.parentSelector
                    ? un('[data-afd-result="Postcode"]')
                        .closest(a.parentSelector)
                        .show()
                    : un('[data-afd-result="Postcode"]').show())
              }
            }),
            h(s(a), 'showResultFields', function () {
              a.controlType,
                a.parentSelector
                  ? a.$resultFields.closest(a.parentSelector).show()
                  : a.$resultFields.show(),
                a.$fieldSets.show()
            }),
            h(s(a), 'fieldEmpty', function (t) {
              return void 0 !== a.result[t] && 0 === a.result[t].length
            }),
            h(s(a), 'onAfdSearchAgainButtonClick', function () {
              var t = a.controlType
              a.$resultFields.val(''),
                a.$searchAgainButton.hide(),
                a.$container
                  .find('[data-afd-control="reverseGeocodeButton"]')
                  .show(),
                a.isReverseGeocode
                  ...
                  : 'typeahead' === t
                    ...
                    : 'lookup' === t &&
                      (a.$lookupButton.show(),
                      a.$lookupField.show().focus().val(''),
                      a.$resultList.empty()),
                void 0 !== a.$button && a.$button.show(),
                a.options[t].beforeHideResults
                  ? (a.$manualInputButton.show(),
                    a.hideResultFields(a.country),
                    a.$fieldSets.hide())
                  : (a.$manualInputButton.hide(),
                    a.showResultFields(),
                    a.$fieldSets.show())
            }),
            h(s(a), 'onAfdManualInputButtonClick', function () {
              var t = a.controlType
              if (
                (a.$manualInputButton.hide(),
                a.$manualInputSearchButton.show(),
                'typeahead' === t
                  ? a.$typeaheadFieldandLabel.hide()
                  : (a.$lookupButton.hide(),
                    a.$lookupField.hide(),
                    a.hideResultsElement()),
                a.showResultFields(),
                a.options[t].fieldSets.length > 0)
              )
                for (var e = 0; e < a.options[t].fieldSets.length; e++)
                  un(a.options[t].fieldSets[e]).show()
              un(document).trigger('afd:manualInputButtonClicked', [
                a.$el,
                a.$container
              ])
            }),
            h(s(a), 'onAfdManualInputSearchButtonClick', function () {
              var t = a.controlType
              'typeahead' === t
                ? a.$typeaheadFieldandLabel.show()
                : 'lookup' === t &&
                  (a.$lookupButton.show(), a.$lookupField.show()),
                a.$manualInputButton.show(),
                a.$manualInputSearchButton.hide(),
                a.hideResultFields(a.country),
                a.$fieldSets.hide()
            }),
            h(s(a), 'onCustomCountryChange', function (t) {
              var e = t.target.value
              if (a.options.country.customCountryConverter) {
                if (
                  'function' != typeof a.options.country.customCountryConverter
                )
                  throw 'customCountryConverter Must be a function'
                e = a.options.country.customCountryConverter(e)
              }
              a.$element.trigger('afd:customCountryChanged', [e]),
                a.onCountryChanged(e)
            }),
            h(s(a), 'onAfdCountryChange', function (t) {
              var e
              ;(e =
                'SELECT' === a.$afdCountryField[0].tagName
                  ? a.$afdCountryField.val()
                  : a.$afdCountryField.countrySelect('getSelectedCountryData')
                      .iso2),
                a.$element.trigger('afd:afdCountryChanged', [e]),
                a.onCountryChanged(e)
            }),
            h(s(a), 'onCountryChanged', function (t) {
              a.$resultFields.val(''),
                a.$typeAheadInput && a.$typeAheadInput.val(''),
                a.$lookupField && a.$lookupField.val(''),
                a.$resultList && a.$resultList.hide(),
                (a.country = t),
                a.handleHideShowControls(t),
                a.$element.trigger('afd:countryChanged', [t]),
                void 0 !== a.onCountryChangedLocal && a.onCountryChangedLocal(t)
            }),
            h(s(a), 'handleHideShowControls', function (t) {
              var e,
                n = a.controlType
              a.$searchAgainButton.hide(), a.$manualInputSearchButton.hide()
              var i = null
              'typeahead' === n
                ? ((e = a.$container.find('[data-afd-control="lookupButton"]')),
                  (i = 'lookup'))
                : 'lookup' === n &&
                  ((e = a.$container.find('[data-afd-control="typeahead"]')),
                  (i = 'typeahead')),
                e.length > 0 && a.options[i].showForCountries.indexOf(t) > -1
                  ? a.hideControls(n)
                  : (a.options[n].hideForCountries.length > 0 &&
                      (a.options[n].hideForCountries.indexOf(t) > -1
                        ? a.hideControls(n)
                        : a.showControls(n)),
                    a.options[n].showForCountries.length > 0 &&
                      (a.options[n].showForCountries.indexOf(t) > -1
                        ? (a.showControls(n),
                          a.options[n].beforeHideResults
                            ? (a.$manualInputButton.show(),
                              a.hideResultFields())
                            : (a.$manualInputButton.hide(),
                              a.showResultFields(),
                              a.$fieldSets.show()))
                        : (a.hideControls(n), a.showResultFields())),
                    0 === a.options[n].hideForCountries.length &&
                      0 === a.options[n].showForCountries.length &&
                      a.showControls(n))
            }),
            h(s(a), 'showControls', function (t) {
              a.isReverseGeocode
                ? a.$button.show()
                : 'lookup' === t
                  ? (a.$lookupButton.closest('.afd-form-control').show(),
                    a.$lookupField.closest('.afd-form-control').show())
                  : a.$typeaheadFieldandLabel.show(),
                a.options[t].manualInputButton && a.$manualInputButton.show()
            }),
            h(s(a), 'hideControls', function (t) {
              'lookup' === t
                ? (a.$lookupButton.closest('.afd-form-control').hide(),
                  a.$lookupField.closest('.afd-form-control').hide(),
                  a.$resultList.closest('.afd-form-control').hide())
                : a.$typeaheadFieldandLabel.hide(),
                a.$manualInputButton.hide()
            }),
            h(s(a), 'getInitialCountry', function () {
              var t = null
              if (a.$customCountryField) {
                if (
                  ((t = a.$customCountryField.val()),
                  a.options.country.customCountryConverter)
                ) {
                  if (
                    'function' !=
                    typeof a.options.country.customCountryConverter
                  )
                    throw 'customCountryConverter Must be a function'
                  t = a.options.country.customCountryConverter(t)
                }
                a.handleHideShowControls(t)
              } else
                a.options.country.defaultCountry
                  ? ((t = a.options.country.defaultCountry),
                    a.handleHideShowControls(a.options.country.defaultCountry))
                  : a.options.defaultCountry &&
                    ((t = a.options.defaultCountry),
                    a.handleHideShowControls(a.options.defaultCountry))
              return t
            }),
            h(s(a), 'handlePushUp', function (t, e, n) {
              var i = t.indexOf(e)
              if (-1 !== i) {
                for (var o = [], r = 0; r < t.length; r++)
                  if (t[r].indexOf(',') > -1) {
                    for (var s = e.split(','), l = 0; l < s.length; l++)
                      a.result[s[l]].length
                    o.push(t[r])
                  } else a.result[t[r]].length > 0 && o.push(t[r])
                void 0 !== o[i] && a.setResultValue(n, o[i])
              } else a.setResultValue(n, e)
            }),
            h(s(a), 'onGeolocationSuccess', function (t) {
              ;(a.position = t),
                void 0 !== a.typeaheadOptions &&
                  ((a.typeaheadOptions.source.lookup.ajax.data.longitude =
                    t.coords.longitude),
                  (a.typeaheadOptions.source.lookup.ajax.data.latitude =
                    t.coords.latitude),
                  a.$element.typeahead(a.typeaheadOptions))
            }),
            h(s(a), 'onGeolocationError', function (t) {
              ;(a.position = null), console.log(t)
            }),
            (a.isReverseGeocode = !1),
            a
          )
        }
        return r(i)
    ...
    _n = yn(vn),
    Mn = gn
  ;((dn && Mn(new dn(new ArrayBuffer(1))) != kn) ||
    (hn && Mn(new hn()) != mn) ||
    (pn && Mn(pn.resolve()) != Cn) ||
    (fn && Mn(new fn()) != bn) ||
    (vn && Mn(new vn()) != wn)) &&
  ...
  var zn = jQuery,
    $n = (function (t) {
      ...
      function i(t, o, a, r) {
        ...
        return (
          n(this, i),
          h(s((l = e.call(this, t, r))), 'onClickButton', function (t) {
            t.preventDefault(), l.handleLookup()
          }),
          h(s(l), 'onKeydownField', function () {
            l.hideResultsElement()
          }),
          h(s(l), 'onKeyupField', function (t) {
            if (
              (l.$lookupButton.attr('disabled', !t.target.value.length),
              13 === (t.keyCode ? t.keyCode : t.which))
            )
              t.preventDefault(), l.handleLookup()
            else if (l.options.lookup.prefetch) {
              var e = l.addressLookup(t.target.value)
              l.preFetchRequests.push(e),
                e.then(function (e, n, i) {
                  i.lookup === t.target.value &&
                    ((l.results = void 0 !== e.Item ? e.Item : []),
                    zn(document).trigger('afd:pcePrefetchComplete', [
                      e,
                      i,
                      i.lookup
                    ]),
                    l.$element.trigger('afd:pcePrefetchComplete', [
                      e,
                      i,
                      i.lookup
                    ]))
          ...
          h(s(l), 'hideResultsElement', function () {
            l.$resultList.closest('.afd-form-control').hide()
          }),
          h(s(l), 'initFieldsLookup', function () {
            l.options.lookup.beforeHideResults &&
              (l.hideResultFields(),
              l.options.lookup.postcodeIsLookup &&
                (l.options.lookup.parentClass
                  ? zn('[data-afd-result="Postcode"]')
                      .closest('.' + l.options.lookup.parentClass)
                      .show()
                  : zn('[data-afd-result="Postcode"]').show()))
          }),
          h(s(l), 'handleLookup', function () {
            var t = l.options.postcodeIsLookup
              ? zn('[data-afd-result="Postcode"]').val()
              : zn('[data-afd-control="lookupField"]').val()
            l.options.lookup.prefetch
              ? (0 === l.preFetchRequests.length &&
                  l.$lookupField.trigger('keyup'),
                Promise.all(l.preFetchRequests).then(function () {
                  l.populateResultsList(),
                    zn(document).trigger('afd:lookupComplete', [l.results]),
                    l.$element.trigger('afd:lookupComplete', [l.results])
                }))
              : l.addressLookup(t).then(function (t) {
                  l.handlePCEError(t.Result, t.Other),
                    (l.results = void 0 !== t.Item ? t.Item : []),
                    l.populateResultsList(),
                    zn(document).trigger('afd:lookupComplete', [l.results]),
                    l.$element.trigger('afd:lookupComplete', [l.results])
                })
          ...
          (l.$lookupField = o),
          (l.$resultList = a),
          (l.controlType = 'lookup'),
          l.setFields(),
          (l.preFetchRequests = []),
          (l.results = []),
          (l.blockChange = !1),
          (l.uniqueID = l.getUniqueID()),
          l
        )
      }
      return (
  ...
  function Tn(t, n) {
    var i = {}
    n ? (i = n) : 'undefined' != typeof afdOptions && (i = afdOptions),
      (i = $.extend(!0, {}, e, i)),
      $(this).each(function (t, e) {
        var n = $(e),
          o =
            0 === i.lookup.containers.length
              ? $(document)
              : n.closest(i.lookup.containers.toString())
        if (o.find('[data-afd-control="lookupButton"]').length > 1)
        ...
        var a = ''
        if (i.lookup.postcodeIsLookup) {
          if (
            ((a = o.find('[data-afd-result="Postcode"]')),
            0 === o.find('[data-afd-result="Postcode"]').length)
          )
          ...
          if (
            ((a = o.find('[data-afd-control="lookupField"]')),
            0 === o.find('[data-afd-control="lookupField"]').length)
          )
        ...
        var r = o.find('[data-afd-control="lookupResultsList"]'),
          s = o.find('[data-afd-control="lookupResultsList"]').length
        if (0 === s)
        ...
        if (s > 1) throw 'More than one instance of `lookupResultsList` found'
        if (!r.is('select, ul'))
          throw (
            '<' +
            n.prop('tagName').toLowerCase() +
  ...
  !(function (t) {
    ...
    var e,
      ...
      a = ~window.navigator.appVersion.indexOf('MSIE 9.'),
    ...
    ;(u.prototype = {
      ...
      extendOptions: function () {
        if (
          ...
          this.options.compression &&
            (('object' ===
              ('undefined' == typeof LZString ? 'undefined' : i(LZString)) &&
              this.options.cache) ||
              (this.options.debug &&
                (d.log({
                  node: this.selector,
          ...
          for (var e = 0, a = this.options.dropdownFilter.length; e < a; ++e)
            this.dropdownFilter[
              this.options.dropdownFilter[e].value ? 'static' : 'dynamic'
            ].push(this.options.dropdownFilter[e])
        }
        this.options.dynamicFilter &&
          !Array.isArray(this.options.dynamicFilter) &&
          (this.options.dynamicFilter = [this.options.dynamicFilter]),
          this.options.accent &&
            ('object' === i(this.options.accent)
          ...
          this.options.resultContainer &&
            ('string' == typeof this.options.resultContainer &&
              (this.options.resultContainer = t(this.options.resultContainer)),
            this.options.resultContainer instanceof t &&
          ...
          (this.options = t.extend(!0, {}, n, this.options))
      },
        ...
        this.options.source))
          if (this.options.source.hasOwnProperty(t)) {
            if (
              ...
              (n = e.url || e.ajax),
              Array.isArray(n)
                ? ((e.ajax = 'string' == typeof n[0] ? { url: n[0] } : n[0]),
                  (e.ajax.path = e.ajax.path || n[1] || null),
                  delete e.url)
                : ('object' === i(e.url)
                    ? (e.ajax = e.url)
      ...
      delegateEvents: function () {
        ...
        t('html')
          ...
          this.node
            ...
            .on('submit', function (t) {
              if (!e.options.mustSelectItem || !e.helper.isEmpty(e.item))
                return (
                  e.options.backdropOnFocus || e.hideLayout(),
                  e.options.callback.onSubmit
                    ? e.helper.executeCallback.call(
                        e,
                        e.options.callback.onSubmit,
                        [e.node, this, e.item || e.items, t]
                      )
                    : void 0
                )
              t.preventDefault()
        ...
        var i = !1
        if (this.node.attr('placeholder') && (r || s)) {
          var o = !0
          this.node.on('focusin focusout', function () {
            o = !(this.value || !this.placeholder)
          }),
            this.node.on('input', function (t) {
              o && (t.stopImmediatePropagation(), (o = !1))
            })
        }
        this.node.off(this.namespace).on(n.join(' '), function (n, o) {
          switch (n.type) {
            case 'generate':
            ...
            case 'focus':
              ...
              e.options.backdropOnFocus &&
                (e.buildBackdropLayout(), e.showLayout()),
                e.options.searchOnFocus &&
                  !e.item &&
                  ((e.deferred = t.Deferred()),
                  e.assignQuery(),
                  e.generateSource())
              break
            case 'keydown':
              ...
              e.options.multiselect.cancelOnBackspace &&
              '' === e.query &&
              e.items.length
                ? e.cancelMultiselectItem(e.items.length - 1, null, n)
                : n.keyCode &&
                  ~[9, 13, 27, 38, 39, 40].indexOf(n.keyCode) &&
                  ((i = !0), e.navigate(n))
              break
            case 'keyup':
              a &&
                e.node[0].value.replace(/^\s+/, '').toString().length <
                  e.query.length &&
            ...
            case 'input':
              ;(e.deferred = t.Deferred()),
                ...
                '' === e.rawQuery &&
                  ...
                  e.helper.executeCallback.call(
                    e,
                    e.options.callback.onCancel,
                    [e.node, e.item, n]
                  ),
                  (e.item = null)),
                e.options.cancelButton && e.toggleCancelButtonVisibility(),
                e.options.hint &&
                  e.hint.container &&
                  '' !== e.hint.container.val() &&
                  0 !== e.hint.container.val().indexOf(e.rawQuery) &&
                  (e.hint.container.val(''),
                  e.isContentEditable && e.hint.container.text('')),
                e.hasDynamicGroups
                  ? e.helper.typeWatch(function () {
                      e.generateSource()
                    }, e.options.delay)
                  : e.generateSource()
              break
            case 'search':
              e.searchResult(),
                e.buildLayout(),
                e.result.length ||
                (e.searchGroups.length && e.displayEmptyTemplate)
                  ? e.showLayout()
                  : e.hideLayout(),
                e.deferred && e.deferred.resolve()
          }
      ...
      generateSource: function (e) {
        ...
        for (
          var i,
            ...
            u,
            c = this,
            h = ((n = 0), this.generateGroups.length);
          n < h;
          ++n
        ) {
          if (
            ((i = this.generateGroups[n]),
            (r = (a = this.options.source[i]).cache),
            (s = a.compression),
            r &&
              (l = window[r].getItem('TYPEAHEAD_' + this.selector + ':' + i)))
          ) {
            s && (l = LZString.decompressFromUTF16(l)), (u = !1)
            try {
              ;(l = JSON.parse(l + '')).data && l.ttl > new Date().getTime()
                ? (this.populateSource(l.data, i),
                  (u = !0),
                  this.options.debug &&
                    (d.log({
                      node: this.selector,
                      function: 'generateSource()',
                      message: 'Source for group "' + i + '" found in ' + r
                    }),
                    d.print()))
                : window[r].removeItem('TYPEAHEAD_' + this.selector + ':' + i)
            } catch (t) {}
            if (u) continue
          }
          !a.data || a.ajax
            ...
            : 'function' == typeof a.data
              ? ((o = a.data.call(this)),
                Array.isArray(o)
                  ? c.populateSource(o, i)
                  : 'function' == typeof o.promise &&
                    (function (e) {
                      t.when(o).then(function (t) {
                        t && Array.isArray(t) && c.populateSource(t, e)
                      })
                    })(i))
              : this.populateSource(t.extend(!0, [], a.data), i)
        }
        return (
      ...
      generateRequestObject: function (t) {
        var e = this,
          n = this.options.source[t],
          i = {
            request: {
              url: n.ajax.url || null,
              dataType: 'json',
              beforeSend: function (i, o) {
                ;(e.xhr[t] = i), e.options.abortAjax || ((i.seq = l), l++)
                var a = e.requests[t].callback.beforeSend || n.ajax.beforeSend
            ...
            extra: { path: n.ajax.path || null, group: t },
            validForGroup: [t]
          }
        if (
          'function' != typeof n.ajax &&
          (n.ajax instanceof Object && (i = this.extendXhrObject(i, n.ajax)),
          Object.keys(this.options.source).length > 1)
        )
          for (var o in this.requests)
            this.requests.hasOwnProperty(o) &&
              (this.requests[o].isDuplicated ||
                (i.request.url &&
                  i.request.url === this.requests[o].request.url &&
                  (this.requests[o].validForGroup.push(t),
                  (i.isDuplicated = !0),
                  delete i.validForGroup)))
        return i
      },
      extendXhrObject: function (e, n) {
        return (
          'object' === i(n.callback) &&
            ((e.callback = n.callback), delete n.callback),
          'function' == typeof n.beforeSend &&
            ((e.callback.beforeSend = n.beforeSend), delete n.beforeSend),
          (e.request = t.extend(!0, e.request, n)),
          'jsonp' !== e.request.dataType.toLowerCase() ||
            e.request.jsonpCallback ||
            (e.request.jsonpCallback = 'callback_' + e.extra.group),
          e
        )
      },
      handleRequests: function () {
        ...
        if (
          ...
          for (var a = 0, r = this.requestGroups.length; a < r; ++a)
            (e = this.requestGroups[a]),
              this.requests[e].isDuplicated ||
                (function (e, a) {
                  if ('function' == typeof n.options.source[e].ajax) {
                    var r = n.options.source[e].ajax.call(n, n.query)
                    if (
                      ((a = n.extendXhrObject(
                        n.generateRequestObject(e),
                        'object' === i(r) ? r : {}
                      )),
                      'object' !== i(a.request) || !a.request.url)
                    )
                      return (
                        n.options.debug &&
                          (d.log({
                  ...
                  var s,
                    ...
                    u = {}
                  if (
                    (~a.request.url.indexOf('{{query}}') &&
                      (l || ((a = t.extend(!0, {}, a)), (l = !0)),
                      (a.request.url = a.request.url.replace(
                        '{{query}}',
                        encodeURIComponent(n.query)
                      ))),
                    a.request.data)
                  )
                    for (var c in a.request.data)
                      if (
                        a.request.data.hasOwnProperty(c) &&
                        ~String(a.request.data[c]).indexOf('{{query}}')
                      ) {
                        l || ((a = t.extend(!0, {}, a)), (l = !0)),
                          (a.request.data[c] = a.request.data[c].replace(
                            '{{query}}',
                            n.query
                          ))
                        break
                  ...
                  t.ajax(a.request)
                    .done(function (t, e, o) {
                      for (var r, l = 0, c = a.validForGroup.length; l < c; l++)
                        (r = a.validForGroup[l]),
                          'function' ==
                            typeof (s = n.requests[r]).callback.done &&
                            ((u[r] = s.callback.done.call(n, t, e, o)),
                            (Array.isArray(u[r]) && 'object' === i(u[r])) ||
                              (n.options.debug &&
                                (d.log({
                                  node: n.selector,
                    ...
                    .fail(function (t, e, i) {
                      for (var o = 0, r = a.validForGroup.length; o < r; o++)
                        (s = n.requests[a.validForGroup[o]]).callback
                          .fail instanceof Function &&
                          s.callback.fail.call(n, t, e, i)
                      n.options.debug &&
                        (d.log({
                          node: n.selector,
                          function: 'Ajax.callback.fail()',
                          arguments: JSON.stringify(a.request),
                          message: e
                        }),
                        console.log(i),
                        d.print())
                    ...
                    .always(function (t, e, i) {
                      for (
                        var r, l = 0, c = a.validForGroup.length;
                        l < c;
                        l++
                      ) {
                        if (
                          ((r = a.validForGroup[l]),
                          (s = n.requests[r]).callback.always instanceof
                            Function && s.callback.always.call(n, t, e, i),
                          'abort' === e)
                        )
                          return
                        if (!n.options.abortAjax) {
                          if (i.seq < n._lastSeq) return
                          n._lastSeq = i.seq
                        }
                        n.populateSource(
                          (null !== t &&
                            ...
                            t,
                          s.extra.group,
                          s.extra.path || s.request.path
                        ),
                          0 === (o -= 1) &&
                            n.helper.executeCallback.call(
                              n,
                              n.options.callback.onReceiveRequest,
                              [n.node, n.query, t]
                            )
                      }
                    })
                    .then(function (t, e) {
                      for (var i = 0, o = a.validForGroup.length; i < o; i++)
                        (s = n.requests[a.validForGroup[i]]).callback
                          .then instanceof Function &&
                          s.callback.then.call(n, t, e)
                    })
                })(e, this.requests[e])
      },
      populateSource: function (e, n, i) {
        var o = this,
          a = this.options.source[n],
          r = a.ajax && a.data,
          s = e
        i &&
          'string' == typeof i &&
          (e = this.helper.namespace.call(this, i, e)),
          void 0 === e &&
            this.options.debug &&
            (d.log({
              node: this.selector,
        ...
        for (
          ...
          null !== e[c] && 'boolean' != typeof e[c]
            ? ('string' == typeof e[c] && (((l = {})[u] = e[c]), (e[c] = l)),
              (e[c].group = n))
            : this.options.debug &&
              (d.log({
                node: this.selector,
        ...
        if (!this.hasDynamicGroups && this.dropdownFilter.dynamic.length) {
          ...
          for (c = 0, h = e.length; c < h; c++)
            for (var g = 0, y = this.dropdownFilter.dynamic.length; g < y; g++)
              (p = this.dropdownFilter.dynamic[g].key),
                (f = e[c][p]) &&
                  (this.dropdownFilter.dynamic[g].value ||
                    (this.dropdownFilter.dynamic[g].value = []),
                  v[p] || (v[p] = []),
                  ~v[p].indexOf(f.toLowerCase()) ||
                    (v[p].push(f.toLowerCase()),
                    this.dropdownFilter.dynamic[g].value.push(f)))
        }
        if (this.options.correlativeTemplate) {
          var m = a.template || this.options.template,
            C = ''
          if (('function' == typeof m && (m = m.call(this, '', {})), m)) {
            if (Array.isArray(this.options.correlativeTemplate))
              for (
                c = 0, h = this.options.correlativeTemplate.length;
                c < h;
                c++
              )
                C += '{{' + this.options.correlativeTemplate[c] + '}} '
            else
              C = m
                .replace(/<.+?>/g, ' ')
                .replace(/\s{2,}/, ' ')
                .trim()
            for (c = 0, h = e.length; c < h; c++)
              e[c].compiled = t('<textarea />')
                .html(
                  C.replace(/\{\{([\w\-\.]+)(?:\|(\w+))?}}/g, function (t, n) {
                    return o.helper.namespace.call(o, n, e[c], 'get', '')
                  }).trim()
                )
                .text()
            a.display
              ? ~a.display.indexOf('compiled') || a.display.unshift('compiled')
        ...
        this.options.callback.onPopulateSource &&
          ((e = this.helper.executeCallback.call(
            this,
            this.options.callback.onPopulateSource,
            [this.node, e, n, i, s, this.query]
          )),
          this.options.debug &&
            ((e && Array.isArray(e)) ||
              (d.log({
              ...
              d.print()))),
          (this.tmpSource[n] = (Array.isArray(e) && e) || [])
        var b = this.options.source[n].cache,
          w = this.options.source[n].compression,
          k = this.options.source[n].ttl || this.options.ttl
        if (b && !window[b].getItem('TYPEAHEAD_' + this.selector + ':' + n)) {
          this.options.callback.onCacheSave &&
            ...
            this.options.debug &&
              ((e && Array.isArray(e)) ||
                ...
                d.print())))
          var S = JSON.stringify({ data: e, ttl: new Date().getTime() + k })
          w && (S = LZString.compressToUTF16(S)),
            window[b].setItem('TYPEAHEAD_' + this.selector + ':' + n, S)
        }
      ...
      navigate: function (t) {
        ...
        if (this.result.length) {
          var e,
            n = this.resultContainer
              .find('.' + this.options.selector.item)
              .not('[disabled]'),
            i = n.filter('.active'),
            o = i[0] ? n.index(i) : null,
            a = i[0] ? i.attr('data-index') : null,
            r = null
          if (
            ...
            this.helper.executeCallback.call(
              ...
              [
                this.node,
                (null !== o && n.eq(o)) || void 0,
                (null !== a && this.result[a]) || void 0,
                t
              ]
            ),
            13 === t.keyCode)
            ...
            return (
              ...
              1 === n.length && n.click(),
              void (i.length > 0
                ? 'javascript:;' === i.find('a:first')[0].href
                  ? i.find('a:first').trigger('click', t)
                  : i.find('a:first')[0].click()
                : this.node.closest('form').trigger('submit'))
            )
          if (15802020 !== t.keyCode) {
            9 === t.keyCode
              ? this.options.blurOnTab
                ...
                : i.length > 0
                  ? o + 1 < n.length
                    ? (t.preventDefault(),
                      (r = o + 1),
                      this.addActiveItem(n.eq(r)))
                    : this.hideLayout()
                  : n.length
                    ? (t.preventDefault(),
                      (r = 0),
                      this.addActiveItem(n.first()))
                    : this.hideLayout()
              : 38 === t.keyCode
                ? (t.preventDefault(),
                  i.length > 0
                    ? o - 1 >= 0 && ((r = o - 1), this.addActiveItem(n.eq(r)))
                    : n.length &&
                      ((r = n.length - 1), this.addActiveItem(n.last())))
                : 40 === t.keyCode &&
                  (t.preventDefault(),
                  i.length > 0
                    ? o + 1 < n.length &&
                      ((r = o + 1), this.addActiveItem(n.eq(r)))
                    : n.length && ((r = 0), this.addActiveItem(n.first()))),
              (e = null !== r ? n.eq(r).attr('data-index') : null),
              this.helper.executeCallback.call(
                this,
                this.options.callback.onEnter,
                [
                  this.node,
                  (null !== r && n.eq(r)) || void 0,
            ...
            this.node.val(s),
              ...
              this.helper.executeCallback.call(
                ...
                [
                  this.node,
                  n,
                  (null !== r && n.eq(r).find('a:first')) || void 0,
                  (null !== e && this.result[e]) || void 0,
                  this.query,
                  t
                ]
      ...
      getTemplateValue: function (t) {
        if (t) {
          var e =
            (t.group && this.options.source[t.group].templateValue) ||
            this.options.templateValue
          if (('function' == typeof e && (e = e.call(this)), !e))
            return this.helper.namespace.call(this, t.matchedKey, t).toString()
          var n = this
          return e.replace(/\{\{([\w\-.]+)}}/gi, function (e, i) {
            return n.helper.namespace.call(n, i, t, 'get', '')
          })
        }
      },
      ...
      searchResultData: function () {
        var e,
          ...
          m = this.options.maxItem,
          C = this.options.maxItemPerGroup,
          b =
        ...
        for (var S = 0, I = this.searchGroups.length; S < I; ++S)
          if (
            ((R = this.searchGroups[S]),
            !this.filters.dropdown ||
              'group' !== this.filters.dropdown.key ||
              this.filters.dropdown.value === R)
          ) {
            ;(r =
              void 0 !== this.options.source[R].filter
                ? this.options.source[R].filter
                : this.options.filter),
              (l =
                ('function' == typeof this.options.source[R].matcher &&
                  this.options.source[R].matcher) ||
                k)
            for (
              var L = 0, x = this.source[R].length;
              L < x &&
              (!(this.resultItemCount >= m) || this.options.callback.onResult);
              L++
            )
              if (
                (!b ||
                  this.dynamicFilter.validate.apply(this, [
                    this.source[R][L]
                  ])) &&
                null !== (e = this.source[R][L]) &&
                'boolean' != typeof e &&
                (!this.options.multiselect ||
                  this.isMultiselectUniqueData(e)) &&
                (!this.filters.dropdown ||
                  (e[this.filters.dropdown.key] || '').toLowerCase() ===
                    (this.filters.dropdown.value || '').toLowerCase())
              ) {
                if (
                  ((g = 'group' === v ? R : e[v] ? e[v] : e.group) &&
                    !this.tmpResult[g] &&
                    ((this.tmpResult[g] = []),
                    (this.resultCountPerGroup[g] = 0)),
                  C &&
                    'group' === v &&
                    this.tmpResult[g].length >= C &&
                    !this.options.callback.onResult)
                )
                  break
                for (
                  var _ = 0,
                    M = (O =
                      this.options.source[R].display || this.options.display)
                      .length;
                  _ < M;
                  ++_
                ) {
                  if (!1 !== r) {
                    if (
                      void 0 ===
                        (a = /\./.test(O[_])
                          ? this.helper.namespace.call(this, O[_], e)
                          : e[O[_]]) ||
                      '' === a
                    ) {
                      this.options.debug && (w[_] = { display: O[_], data: e })
                      continue
                    }
                    a = this.helper.cleanStringFromScript(a)
                  }
                  if ('function' == typeof r) {
                    if (void 0 === (s = r.call(this, e, a))) break
                    if (!s) continue
                    'object' === i(s) && (e = s)
                  }
                  if (~[void 0, !0].indexOf(r)) {
                    if (null === a) continue
                    if (
                      ((o = (o = a).toString().toLowerCase()),
                      this.options.accent &&
                        (o = this.helper.removeAccent.call(this, o)),
                      (n = o.indexOf(y)),
                      ...
                      ;(c = !0), (p = o)
                      for (var A = 0, E = (h = y.split(' ')).length; A < E; A++)
                        if ('' !== h[A]) {
                          if (!~p.indexOf(h[A])) {
                            c = !1
                            break
                    ...
                    if (n < 0 && !c) continue
                    if (this.options.offset && 0 !== n) continue
                    if (l) {
                      if (void 0 === (u = l.call(this, e, a))) break
                      if (!u) continue
                      'object' === i(u) && (e = u)
                    }
                  }
                  if (
                    (this.resultCount++,
                    this.resultCountPerGroup[g]++,
                    this.resultItemCount < m)
                  ) {
                    if (C && this.tmpResult[g].length >= C) break
                    this.tmpResult[g].push(
                      t.extend(!0, { matchedKey: O[_] }, e)
                    ),
                ...
                if (!this.options.callback.onResult) {
                  if (this.resultItemCount >= m) break
                  if (C && this.tmpResult[g].length >= C && 'group' === v) break
                }
              }
          }
        if (
          (this.options.debug &&
            (this.helper.isEmpty(w) ||
              (d.log({
                node: this.selector,
                function: 'searchResult()',
                arguments: JSON.stringify(w),
                message:
          ...
          var F,
            O = []
          for (var R in this.tmpResult)
            if (this.tmpResult.hasOwnProperty(R)) {
              for (S = 0, I = this.tmpResult[R].length; S < I; S++)
                (F =
                  this.options.source[this.tmpResult[R][S].group].display ||
                  this.options.display),
                  ~O.indexOf(F[0]) || O.push(F[0])
              this.tmpResult[R].sort(
                f.helper.sort(O, 'asc' === f.options.order, function (t) {
        ...
        for (
          ...
          z = z.concat(this.tmpResult[$[S]] || [])
        ;(this.groups = JSON.parse(JSON.stringify($))), (this.result = z)
      },
      buildLayout: function () {
        this.buildHtmlLayout(),
          ...
          this.tmpResultHtml instanceof t
            ? this.resultContainer.html(this.tmpResultHtml)
            : this.resultHtml instanceof t &&
        ...
        if (!1 !== this.options.resultContainer) {
          ...
          if (
            ...
            if (
              ...
              e = this.options.multiselect.limitTemplate
          ...
          for (
            var s,
              ...
              m,
              C,
              b = (this.groupTemplate && this.result.length && o.groups) || [],
              w = 0,
              k = this.result.length;
            w < k;
            ++w
          )
            (s = (u = this.result[w]).group),
              (c =
                (!this.options.multiselect &&
                  this.options.source[u.group].href) ||
                this.options.href),
              (f = []),
              (v =
                this.options.source[u.group].display || this.options.display),
              this.options.group &&
                ((s = u[this.options.group.key]),
                this.options.group.template &&
                  ('function' == typeof this.options.group.template
                    ? (l = this.options.group.template.call(this, u))
                    : 'string' == typeof this.options.group.template &&
                      (l = this.options.group.template.replace(
                        /\{\{([\w\-\.]+)}}/gi,
                        function (t, e) {
                          return o.helper.namespace.call(o, e, u, 'get', '')
                        }
                      ))),
                a.find('[data-search-group="' + s + '"]')[0] ||
                  (this.groupTemplate
                    ? a.find('[data-group-template="' + s + '"] ul')
                    : a
                  ).append(
                    t('<li/>', {
              ...
              this.groupTemplate &&
                b.length &&
                ~(y = b.indexOf(s || u.group)) &&
                b.splice(y, 1),
              (d = t('<li/>', {
                class:
                  o.options.selector.item +
                  ' ' +
                  o.options.selector.group +
                  '-' +
                  this.helper.slugify.call(this, s),
                disabled: !!u.disabled,
                'data-group': s,
                'data-index': w,
                html: t('<a/>', {
                  href:
                    c && !u.disabled
                      ? ((m = c),
                        (C = u),
                        (C.href = o.generateHref.call(o, m, C)))
                      : 'javascript:;',
                  html: function () {
                    if (
                      (h =
                        (u.group && o.options.source[u.group].template) ||
                        o.options.template)
                    )
                      'function' == typeof h && (h = h.call(o, o.query, u)),
                        (p = h.replace(
                          /\{\{([^\|}]+)(?:\|([^}]+))*}}/gi,
                          function (t, e, i) {
                            var a = o.helper.cleanStringFromScript(
                              String(
                                o.helper.namespace.call(o, e, u, 'get', '')
                              )
                            )
                            return (
                              ~(i = (i && i.split('|')) || []).indexOf(
                                'slugify'
                              ) && (a = o.helper.slugify.call(o, a)),
                              ~i.indexOf('raw') ||
                                (!0 === o.options.highlight &&
                                  n &&
                                  ~v.indexOf(e) &&
                                  (a = o.helper.highlight.call(
                                    o,
                                    a,
                                    n.split(' '),
                                    o.options.accent
                      ...
                      for (var e = 0, i = v.length; e < i; e++)
                        void 0 !==
                          (g = /\./.test(v[e])
                            ? o.helper.namespace.call(o, v[e], u, 'get', '')
                            : u[v[e]]) &&
                          '' !== g &&
                          f.push(g)
                      p =
                        '<span class="' +
                        o.options.selector.display +
                        '">' +
                        o.helper.cleanStringFromScript(String(f.join(' '))) +
                        '</span>'
                    }
                    ;((!0 === o.options.highlight && n && !h) ||
                      'any' === o.options.highlight) &&
                      (p = o.helper.highlight.call(
                        o,
                        p,
                        n.split(' '),
                        o.options.accent
              ...
              (function (e, n, a) {
                a.on('click', function (e, a) {
                  n.disabled
                    ? e.preventDefault()
                    : (a && 'object' === i(a) && (e.originalEvent = a),
                      o.options.mustSelectItem && o.helper.isEmpty(n)
                        ? e.preventDefault()
                        : (o.options.multiselect || (o.item = n),
                          !1 !==
                            o.helper.executeCallback.call(
                              o,
                              o.options.callback.onClickBefore,
                              [o.node, t(this), n, e]
                            ) &&
                            ((e.originalEvent &&
                              ...
                              (o.options.multiselect
                                ? ((o.query = o.rawQuery = ''),
                                  o.addMultiselectItemLayout(n))
                                : ((o.focusOnly = !0),
                                  (o.query = o.rawQuery =
                                    o.getTemplateValue.call(o, n)),
                                  o.isContentEditable &&
                                    (o.node.text(o.query),
                                    o.helper.setCaretAtEnd(o.node[0]))),
                              o.hideLayout(),
                              o.node.val(o.query),
                              o.options.cancelButton &&
                                o.toggleCancelButtonVisibility(),
                              o.helper.executeCallback.call(
                                o,
                                o.options.callback.onClickAfter,
                                [o.node, t(this), n, e]
                              )))))
                }),
                  a.on('mouseenter', function (e) {
                    n.disabled ||
                      (o.clearActiveItem(), o.addActiveItem(t(this))),
                      o.helper.executeCallback.call(
                        o,
                        o.options.callback.onEnter,
                        [o.node, t(this), n, e]
                      )
                  }),
                  a.on('mouseleave', function (e) {
                    n.disabled || o.clearActiveItem(),
                      o.helper.executeCallback.call(
                        o,
                        o.options.callback.onLeave,
                        [o.node, t(this), n, e]
                      )
                  })
              })(0, u, d),
          ...
          if (this.result.length && b.length)
            for (w = 0, k = b.length; w < k; ++w)
              a.find('[data-group-template="' + b[w] + '"]').remove()
          this.resultHtml = a
        }
      },
        ...
        return (
          'string' == typeof t
            ? (t = t.replace(
                /\{\{([^\|}]+)(?:\|([^}]+))*}}/gi,
                function (t, i, o) {
                  var a = n.helper.namespace.call(n, i, e, 'get', '')
                  return (
                    ~(o = (o && o.split('|')) || []).indexOf('slugify') &&
                      (a = n.helper.slugify.call(n, a)),
                    a
                  )
                }
              ))
      ...
      getMultiselectComparedData: function (t) {
        ...
        if (Array.isArray(this.options.multiselect.matchOn))
          for (
            var n = 0, i = this.options.multiselect.matchOn.length;
            n < i;
            ++n
          )
            e +=
              void 0 !== t[this.options.multiselect.matchOn[n]]
                ? t[this.options.multiselect.matchOn[n]]
                : ''
        else {
          var o = JSON.parse(JSON.stringify(t)),
            a = ['group', 'matchedKey', 'compiled', 'href']
          for (n = 0, i = a.length; n < i; ++n) delete o[a[n]]
          e = JSON.stringify(o)
        }
        return e
      },
            ...
            if (
              ...
              if (
                (this.hint.container ||
                  ...
                  (this.hint.container = t('<' + this.node[0].nodeName + '/>', {
                ...
                for (var a, r, s, l = 0, u = e.length; l < u; l++)
                  if (!e[l].disabled) {
                    r = e[l].group
                    for (
                      var c = 0,
                        d = (a =
                          this.options.source[r].display ||
                          this.options.display).length;
                      c < d;
                      c++
                    )
                      if (
                        ((s = String(e[l][a[c]]).toLowerCase()),
                        this.options.accent &&
                          (s = this.helper.removeAccent.call(this, s)),
                        0 === s.indexOf(o))
                      ) {
                        ;(i = String(e[l][a[c]])), (this.hintIndex = l)
                        break
                      }
              ...
              var h =
                ...
                ''
              this.hint.container.val(h),
                this.isContentEditable && this.hint.container.text(h)
            }
          }
      },
              ...
              t(this).append(
                t('<button/>', {
                  ...
                  click: function () {
                    ...
                    var n = e.namespace + '-dropdown-filter'
                    t('html').off(n),
                      e.container.hasClass('filter') &&
                        t('html').on(
                          'click' + n + ' touchend' + n,
                          function (i) {
                            ;(t(i.target).closest(
                              '.' + e.options.selector.filter
                            )[0] &&
                              t(i.target).closest(e.container)[0]) ||
                              e.hasDragged ||
                              (e.container.removeClass('filter'),
                              t('html').off(n))
                          }
                        )
                  }
                ...
                t(this).append(
                  t('<ul/>', { class: e.options.selector.dropdown })
                )
            }
      ...
      buildDropdownItemLayout: function (e) {
        if (this.options.dropdownFilter) {
          ...
          for (var s = 0, l = this.dropdownFilter[e].length; s < l; s++) {
            ;(i = this.dropdownFilter[e][s]),
              Array.isArray(i.value) || (i.value = [i.value]),
              i.all && (this.dropdownFilterAll = i.all)
            for (var u = 0, c = i.value.length; u <= c; u++)
              (u === c && s !== l - 1) ||
                (u === c &&
                  s === l - 1 &&
                  'static' === e &&
                  this.dropdownFilter.dynamic.length) ||
                ((n = this.dropdownFilterAll || a),
                i.value[u]
                  ? (n = i.template
                      ? i.template.replace(
                          new RegExp('{{' + i.key + '}}', 'gi'),
      ...
      dynamicFilter: {
        ...
        validate: function (t) {
          var e,
            ...
            i = null,
            o = null
          for (var a in this.filters.dynamic)
            if (
              this.filters.dynamic.hasOwnProperty(a) &&
              ((n = ~a.indexOf('.')
                ? this.helper.namespace.call(this, a, t, 'get')
                : t[a]),
              '|' !== this.filters.dynamic[a].modifier ||
                i ||
                (i = n == this.filters.dynamic[a].value || !1),
              '&' === this.filters.dynamic[a].modifier)
            ) {
              if (n != this.filters.dynamic[a].value) {
                o = !1
                break
              }
              o = !0
        ...
        set: function (t, e) {
          var n = t.match(/^([|&])?(.+)/)
          e
            ? (this.filters.dynamic[n[2]] = { modifier: n[1] || '|', value: e })
            : delete this.filters.dynamic[n[2]],
            this.dynamicFilter.isEnabled && this.generateSource()
        },
        bind: function () {
          for (
            var e, n = this, i = 0, o = this.options.dynamicFilter.length;
            i < o;
            i++
          )
            'string' == typeof (e = this.options.dynamicFilter[i]).selector &&
              (e.selector = t(e.selector)),
              e.selector instanceof t && e.selector[0] && e.key
                ? (function (t) {
                    t.selector
                      .off(n.namespace)
                      .on('change' + n.namespace, function () {
                        n.dynamicFilter.set.apply(n, [
                          t.key,
                          n.dynamicFilter.getValue(this)
                        ])
                      })
                      .trigger('change' + n.namespace)
                  })(e)
                : this.options.debug &&
                  (d.log({
                    node: this.selector,
          ...
          return (
            'SELECT' === t.tagName
              ...
              : 'INPUT' === t.tagName &&
                ('checkbox' === t.type
                  ? (e =
                      (t.checked && t.getAttribute('value')) ||
                      t.checked ||
                      null)
      ...
      buildMultiselectLayout: function () {
        if (this.options.multiselect) {
          ...
          ;(this.label.container = t('<span/>', {
            ...
            click: function (e) {
              t(e.target).hasClass(n.options.selector.labelContainer) &&
                n.node.focus()
            }
          })),
            this.node
            ...
            this.options.multiselect.data &&
              (Array.isArray(this.options.multiselect.data)
                ...
                : 'function' == typeof this.options.multiselect.data &&
                  ((e = this.options.multiselect.data.call(this)),
                  Array.isArray(e)
                    ? this.populateMultiselectData(e)
                    : 'function' == typeof e.promise &&
                      t.when(e).then(function (t) {
                        t && Array.isArray(t) && n.populateMultiselectData(t)
                      })))
        }
      },
      isMultiselectUniqueData: function (t) {
        for (var e = !0, n = 0, i = this.comparedItems.length; n < i; ++n)
          if (this.comparedItems[n] === this.getMultiselectComparedData(t)) {
            e = !1
            break
          }
        return e
      ...
      addMultiselectItemLayout: function (e) {
        if (this.isMultiselectUniqueData(e)) {
          this.items.push(e),
            this.comparedItems.push(this.getMultiselectComparedData(e))
          var n = this.getTemplateValue(e),
            i = this,
            ...
            a = t('<span/>', {
              ...
              html: t('<' + o + '/>', {
                text: n,
                click: function (e) {
                  var n = t(this).closest('.' + i.options.selector.label),
                    o = i.label.container
                      .find('.' + i.options.selector.label)
                      .index(n)
                  i.options.multiselect.callback &&
                    i.helper.executeCallback.call(
                      i,
                      i.options.multiselect.callback.onClick,
                      [i.node, i.items[o], e]
                    )
                },
                href: this.options.multiselect.href
                  ? (function (t) {
                      return i.generateHref.call(
                        i,
                        i.options.multiselect.href,
                        t
                      )
                ...
                click: function (e) {
                  var n = t(this).closest('.' + i.options.selector.label),
                    o = i.label.container
                      .find('.' + i.options.selector.label)
                      .index(n)
                  i.cancelMultiselectItem(o, n, e)
                }
              })
            ),
            this.label.container.append(a),
            this.adjustInputSize(),
            !0
          )
        }
      },
      cancelMultiselectItem: function (t, e, n) {
        var i = this.items[t]
        ;(e =
          e ||
          ...
          .filter(function (s, l) {
            0 === s &&
              (r =
                ...
                parseFloat(t(l).css('margin-bottom') || 0)),
              (n =
                t(l)[0].getBoundingClientRect().width +
                parseFloat(t(l).css('margin-right') || 0)),
              o + n > 0.7 * e && !a && (i++, (a = !0)),
              o + n < e ? (o += n) : ((a = !1), (o = n))
          })
        var s =
            ...
            (a ? 0 : o),
          l = i * r + parseFloat(this.label.container.data('padding-top') || 0)
        this.container
          .find('.' + this.options.selector.query)
          .find('input, textarea, [contenteditable], .typeahead__hint')
          .css({ paddingLeft: s, paddingTop: l })
      },
      showLayout: function () {
        !this.container.hasClass('result') &&
          ...
          (function () {
            ...
            t('html')
              ...
              .on('keydown' + this.namespace, function (n) {
                n.keyCode &&
                  9 === n.keyCode &&
                  setTimeout(function () {
                    t(':focus').closest(e.container).find(e.node)[0] ||
                      e.hideLayout()
                  }, 0)
              }),
              t('html')
                ...
                .on(
                  ...
                  function (n) {
                    t(n.target).closest(e.container)[0] ||
                      t(n.target).closest('.' + e.options.selector.item)[0] ||
                      n.target.className === e.options.selector.cancelButton ||
                      e.hasDragged ||
                      e.hideLayout()
                  }
                )
      ...
      hideLayout: function () {
        ;(this.container.hasClass('result') ||
          ...
          (this.container.removeClass(
            'result hint filter' +
              (this.options.backdropOnFocus && t(this.node).is(':focus')
                ? ''
                : ' backdrop')
          ),
          (this.options.backdropOnFocus &&
            this.container.hasClass('backdrop')) ||
            (t('html').off(this.namespace),
            this.helper.executeCallback.call(
              this,
      ...
      helper: {
        ...
        removeAccent: function (t) {
          if ('string' == typeof t) {
            var e = o
            return (
              'object' === i(this.options.accent) && (e = this.options.accent),
              (t = t
                .toLowerCase()
        ...
        sort: function (t, e, n) {
          var i = function (e) {
            for (var i = 0, o = t.length; i < o; i++)
              if (void 0 !== e[t[i]]) return n(e[t[i]])
            return e
          }
          return (
            (e = [-1, 1][+!!e]),
            function (t, n) {
              return (t = i(t)), (n = i(n)), e * ((t > n) - (n > t))
            }
          )
        },
        replaceAt: function (t, e, n, i) {
          return t.substring(0, e) + i + t.substring(e + n)
        },
        highlight: function (t, e, n) {
          t = String(t)
          var i = (n && this.helper.removeAccent.call(this, t)) || t,
            o = []
          Array.isArray(e) || (e = [e]),
            e.sort(function (t, e) {
          ...
          i.replace(
            ...
            function (t, e, n) {
              o.push({ offset: n, length: t.length })
            }
          )
          for (a = o.length - 1; a >= 0; a--)
            t = this.helper.replaceAt(
              ...
              o[a].offset,
              o[a].length,
              '<strong>' + t.substr(o[a].offset, o[a].length) + '</strong>'
            )
          return t
        },
        getCaret: function (t) {
        ...
        executeCallback: function (t, e) {
          if (t) {
            ...
            if ('function' == typeof t) n = t
              ...
              ('string' == typeof t && (t = [t, []]),
              'function' !=
                typeof (n = this.helper.namespace.call(this, t[0], window)))
            )
              return void (
                this.options.debug &&
                (d.log({
            ...
            return n.apply(this, (t[1] || []).concat(e || []))
          }
        },
        namespace: function (t, e, n, i) {
          ...
          for (
            ...
            if (void 0 === r[(s = a[l])]) {
              if (~['get', 'delete'].indexOf(n))
                return void 0 !== i ? i : void 0
              r[s] = {}
            }
            if (~['set', 'create', 'delete'].indexOf(n) && l === u - 1) {
              if ('set' !== n && 'create' !== n) return delete r[s], !0
              r[s] = o
            }
            r = r[s]
          }
      ...
      ((t = jQuery).fn.typeahead = t.typeahead =
        function (t) {
          return c.typeahead(this, t)
        })
    var c = {
        typeahead: function (e, n) {
          if (!n || !n.source || 'object' !== i(n.source))
            return (
              d.log({
                node: e.selector || (n && n.input),
                function: '$.typeahead()',
          ...
          if ((void 0 === e[0].value && (e[0].value = e.text()), !e.length))
            return (
              d.log({
                node: e.selector,
                function: '$.typeahead()',
                ...
                message:
                  'Unable to find jQuery input element - Typeahead dropped'
              }),
              void d.print()
            )
          if (1 === e.length)
            return (
              (e[0].selector =
                e.selector || n.input || e[0].nodeName.toLowerCase()),
              (window.Typeahead[e[0].selector] = new u(e, n))
            )
          for (var o, a = {}, r = 0, s = e.length; r < s; ++r)
            void 0 !== a[(o = e[r].nodeName.toLowerCase())] && (o += r),
              (e[r].selector = o),
              (window.Typeahead[o] = a[o] = new u(e.eq(r), n))
          return a
        }
      },
      d = {
        ...
        log: function (e) {
          e.message &&
            ...
            (this.table[e.message] = t.extend(
              { node: '', function: '', arguments: '' },
              e
            ))
        },
        print: function () {
          !u.prototype.helper.isEmpty(this.table) &&
            console &&
            console.table &&
            (this.table = {})
        }
  ...
  var Vn = jQuery,
    Nn = (function (t) {
      ...
      function i(t, o) {
        ...
        return (
          n(this, i),
          h(s((a = e.call(this, t, o))), 'init', function () {
            try {
              a.initFields(), a.$element.typeahead(a.typeaheadOptions)
            } catch (t) {
              console.error('Error initisalising typeahead control'),
                console.error(t)
            }
            var t = a.eventHandler
            t(a.$element, 'input', a.onInput),
              t(a.$element, 'afd:initFields', a.onAfdInitFields),
              t(a.$element, 'focusin', a.onFocusIn),
              t(a.$searchAgainButton, 'click', a.onAfdSearchAgainButtonClick),
              a.options.typeahead.manualInputButton &&
                t(a.$manualInputButton, 'click', a.onAfdManualInputButtonClick),
              a.options.typeahead.manualInputButton &&
                t(
                  a.$manualInputSearchButton,
                  'click',
                  a.onAfdManualInputSearchButtonClick
                ),
              a.getInitialCountry()
          }),
          h(s(a), 'setupTypeaheadRequestOptions', function () {
            a.initRequestSequence()
            var t = {
              data: 'address',
              fields: a.options.typeahead.postcodeFirst ? 'list' : 'fflist',
              task: 'fastfindv4',
              lookup: '{{query}}',
              allpc: '1',
              matchPositions: a.options.typeahead.matchPositions ? 1 : 0,
              maxquantity: a.options.typeahead.maxItems,
              uniqueid: a.uniqueID,
              w3wmode: a.options.typeahead.wThreeWMode
            }
            a.options.typeahead.listEnv && (t.listEnv = '1'),
              a.options.typeahead.bankLookup &&
                ((t.data = 'bank'),
                (t.task = 'fastfind'),
                (t.clearing = 'all')),
              Vn.extend(t, a.options.typeahead.extraPCESearchParams),
              (a.requestOptions = a.setupParams(t)),
              (a.requestOptions.path = 'Item')
          }),
          h(s(a), 'prepareTypeaheadOptions', function () {
            return {
              dynamic: !0,
              source: { lookup: { ajax: a.requestOptions } },
              ...
              filter: !1,
              maxItem: 0,
              minLength: a.options.typeahead.minLength,
              delay: 20,
              abortAjax: !1,
              selector: a.getTypeaheadSelectors(),
              callback: {
                onResult: a.onResult,
                onShowLayout: a.onShowLayout,
                onHideLayout: a.onHideLayout,
                onLayoutBuiltBefore: a.onLayoutBuiltBefore,
                onLayoutBuiltAfter: a.onLayoutBuiltAfter,
                onSearch: a.onSearch,
                onNavigateBefore: a.onNavigateBefore,
                onNavigateAfter: a.onNavigateAfter,
                onClickAfter: a.onClickAfter,
                onPopulateSource: a.onPopulateSource,
                onReceiveRequest: a.onReceiveRequest
              }
            }
          }),
          h(s(a), 'onInput', function (t) {
            var e = a.containers.length > 0 ? Vn(a.containers) : Vn(document)
            e.find('.afd-typeahead-status').html('&nbsp;'),
              e.find('[data-afd-control="reverseGeocodeResultsList"]').hide(),
              Vn(document).trigger('afd:typeaheadInput', [t.target.value]),
              a.$element.trigger('afd:typeaheadInput', [t.target.value])
          }),
          h(s(a), 'onFocusIn', function () {
            'focus' === a.options[a.controlType].wThreeWReverseGeocode &&
              navigator.geolocation.getCurrentPosition(
                a.onGeolocationSuccess,
                a.onGeolocationError
              )
          }),
          h(s(a), 'onCountryChangedLocal', function (t) {
            ;(a.typeaheadOptions.source.lookup.ajax.data.countryiso = t),
              a.$element.typeahead(a.typeaheadOptions)
          }),
          h(s(a), 'onAfdInitFields', function () {
            a.$element.typeahead(a.typeaheadOptions),
              a.setFields(),
              a.initFields()
          }),
          h(s(a), 'onResult', function (t, e, n) {
            ;(a.containers.length > 0 ? Vn(a.containers) : Vn(document))
              .find('.afd-typeahead-status')
              .html(n.length + ' results found'),
              a.options.typeahead.beforeHideResults &&
                a.options.typeahead.fewResultsManualInput &&
                n.length < a.options.typeahead.maxItems &&
                e.length > 3 &&
                window.Typeahead.input.result.push({
                  List: a.options.typeahead.fewResultsManualInputText,
                  Key: null,
                  group: 'lookup',
                  matchedKey: 'display'
                })
          }),
          h(s(a), 'onShowLayout', function (t, e) {
            a.$manualInputButton.hide()
          }),
          h(s(a), 'onHideLayout', function (t, e) {
            var n = a.containers.length > 0 ? Vn(a.containers) : Vn(document)
            !(0 === n.find('[data-afd-result]:hidden').length) &&
              a.options.typeahead.manualInputButton &&
              a.$manualInputButton.show(),
              n.find('.provider').remove()
          }),
          h(s(a), 'onLayoutBuiltBefore', function (t, e, n, i) {
            if (0 === n.length) return i
            var o =
              a.containers.length > 0
                ? '-' + a.$element.closest(a.containers.toString()).attr('id')
                : ''
            if (
              (i.attr('id', 'afd-results' + o).attr('role', 'listbox'),
              a.options.typeahead.matchPositions &&
                void 0 !== n[0].matchPositions)
            )
              for (
                var r = '<span class="afd-matched-highlight">',
                  s = '</span>',
                  l = 0;
                l < n.length;
                l++
                ...
                var u = n[l],
                  c = Vn(i.children().eq(l)).text()
                if (void 0 !== u.matchPositions)
                  for (var d = 0; d < u.matchPositions.length; d++) {
                    var h = u.matchPositions[d],
                      p = 43 * d,
                      f = ''
                    ;(f += c.substr(0, h[0] + p)),
                      (f += r),
                      (f += c.substr(h[0] + p, h[1] - h[0])),
                      (f += s),
                      (f += c.substr(h[1] + p)),
                      (c = f)
                  }
                var v = '<a href="javascript:;">'
                ;(v += c), (v += '</a>'), i.children().eq(l).html(v)
              }
            for (var g = 0; g < n.length; g++)
              if (void 0 !== n[g].Near) {
                var y =
                  'm' === a.options.typeahead.wThreeWDistanceUnit.toLowerCase()
                    ? 'Miles'
                    : 'Km'
                i
                  .children()
                  .eq(g)
                  .append(
                    '<span class="afd-near">   near ' + n[g].Near + '</span>'
                  ),
                  i
                    .children()
                    .eq(g)
                    .append(
                      '<span class="afd-near-distance">  ( ' +
                        n[g][y] +
                        ' ' +
                        y.toLowerCase() +
                        '</span>'
            ...
            return (
              1 === n.length && i.children().addClass('active'),
              i.children().attr('role', 'option'),
              i.children().each(function (t) {
                i.children()
                  .eq(t)
                  .attr('id', 'afd-result-' + t)
              }),
              i.attr('aria-label', 'Results'),
              i
            )
          }),
          h(s(a), 'onLayoutBuiltAfter', function (t) {
            var e = t
              .closest('.afd-typeahead-field')
              .siblings('.afd-typeahead-result')
            a.options.typeahead.providerInfo &&
              e.prepend('<div class="provider"></div>'),
              a.wThreeW
                ? e
                    .find('.provider')
                    .html(a.wThreeWLogo + '<strong> what3words</strong>')
                : e
                    .find('.provider')
                    .html(a.afdLogo + '<strong> afd Software</strong>')
          }),
          h(s(a), 'onSearch', function (t, e) {
            Vn('.' + a.typeaheadOptions.selector.result).empty()
          }),
          h(s(a), 'onNavigateBefore', function (t, e, n) {
            ~[38, 40].indexOf(event.keyCode) && (n.preventInputChange = !0)
          }),
          h(s(a), 'onNavigateAfter', function (t, e, n, i, o, r) {
            var s = e.filter('li.active'),
              l = a.containers.length > 0 ? Vn(a.containers) : Vn(document)
            if (~[38, 40].indexOf(r.keyCode)) {
              var u = l.find('.afd-typeahead-list'),
                c = (s[0] && s[0].offsetTop - u.height() / 2) || 0
              u.scrollTop(c)
            }
            e.removeAttr('aria-selected'),
              s.attr('aria-selected', 'true'),
              a.$element.attr('aria-activedescendant', s.attr('id'))
          }),
          h(s(a), 'onClickAfter', function (t, e, n, i) {
            if (
              ((a.containers.length > 0 ? Vn(a.containers) : Vn(document))
                .find('.afd-typeahead-status')
                .html('&nbsp;'),
              a.options.typeahead.afterClearTypeahead &&
                Vn('.afd-typeahead-field input').val(''),
              !n.Key)
            )
              return (
                a.showResultFields(),
                ...
                a.$manualInputButton.hide(),
                a.$manualInputSearchButton.show(),
                void a.$typeaheadFieldandLabel.hide()
              )
            n.suggestion
              ? Vn(t).val(n.Key).trigger('input')
              : a
                  .addressRetrieve(n.Key)
                  .then(function (t, e, n) {
                    a.handleAddressRetrieve(t, n)
                  })
                  .fail(function (t) {
                    return a.handlePCEError(t)
                  })
          }),
          h(s(a), 'onPopulateSource', function (t, e, n, i, o, a) {
            return e.map(function (t) {
              ...
              return Pn(
                ...
                {
                  List: e,
                  suggestion: void 0 !== o.Suggestion,
                  wThreeW: void 0 !== o.W3W
                }
              )
            })
          }),
          h(s(a), 'onReceiveRequest', function (t, e, n) {
            ;-7 === n.Result && a.handlePCEError('-7', n.ErrorText)
          }),
          h(s(a), 'getTypeaheadSelectors', function (t) {
            return {
          ...
          (a.controlType = 'typeahead'),
          (a.$reverseGeocodeButton = t.siblings(
            '.afd-typeahead-reverse-geocode-button'
          )),
          a.setFields(),
          (a.uniqueID = a.getUniqueID()),
          a.setupTypeaheadRequestOptions(),
          (a.typeaheadOptions = a.prepareTypeaheadOptions()),
          a
        )
      }
      return r(i)
  ...
  function jn(t, n) {
    var i = jQuery,
      o = {}
    n ? (o = n) : 'undefined' != typeof afdOptions && (o = afdOptions),
      (o = i.extend(!0, {}, e, o))
    var a = i(this)
    if (
      ((0 === o.typeahead.containers.length
        ? i(document)
      ...
      throw (
        '<' +
        a.prop('tagName').toLowerCase() +
        '> is not a valid tag for `[data-afd-control="typeahead"]`, use <input>'
      )
    var r = new Nn(a, o)
    i(document)
      .off('afd:init.afd')
  ...
  var Un,
    qn = jQuery
  ;(Un = navigator.userAgent || navigator.vendor || window.opera),
  ...
  var Hn = (function (t) {
    ...
    function i(t, o, a) {
      ...
      return (
        n(this, i),
        h(s((r = e.call(this, t, a))), 'init', function () {
          r.hideResultsElement(r.$resultList, r.options)
          var t = r.eventHandler
          t(r.$button, 'click', r.onButtonClick),
            t(qn(document), 'afd:initFields', r.onAfdInitFields),
            t(r.$resultList, 'keydown', r.onKeyDownResult),
            t(r.$resultList, 'keyup', r.onKeyUpResult),
            t(r.$resultList, 'change', r.onChangeResult),
            !qn.browser.mobile &&
              r.options.reverseGeocode.hideOnDesktop &&
              (r.options.buttonContainer
                ? r.$button.closest(r.options.buttonContainer).hide()
                : r.$button.hide()),
            r.$resultList.hide()
          try {
            r.initFields()
        ...
        h(s(r), 'setupReverseGeocodeRequestOptions', function (t, e) {
          r.requestOptions = r.setupParams({
            data: 'address',
            fields: r.options.reverseGeocode.postcodeFirst ? 'list' : 'fflist',
            task: 'nearest',
            maxquantity: r.options.reverseGeocode.maxItems,
            longitude: t,
            latitude: e
          })
        }),
        h(s(r), 'onAfdInitFields', function () {
          r.setFields()
        }),
        h(s(r), 'onCountryChangedLocal', function (t) {
          r.checkVisibilityByCountry(t)
        }),
        h(s(r), 'checkVisibilityByCountry', function (t) {
          ;['gb', 'gbr', 'GB', 'GBR', 'United Kingdom'].indexOf(t) > -1
            ? (r.$button.show(),
              r.$container.find('[data-afd-control="reverseGeocode"]').show())
            : (r.$button.hide(),
              r.$container.find('[data-afd-control="reverseGeocode"]').hide())
        }),
        h(s(r), 'onButtonClick', function (t) {
          navigator.geolocation.getCurrentPosition(
            function (t) {
              r.setupReverseGeocodeRequestOptions(
                t.coords.longitude,
                t.coords.latitude
              ),
                qn.ajax(r.requestOptions).then(function (t) {
                  ;(r.results = void 0 !== t.Item ? t.Item : []),
                    r.populateResultsList()
                })
            },
            function (t) {
              r.$button.hide(),
        ...
        (r.controlType = r.options.reverseGeocode.linkedControl
          ? r.options.reverseGeocode.linkedControl
          : 'reverseGeocode'),
        (r.originalControlType = 'reverseGeocode'),
        (r.$button = t),
        (r.$resultList = o),
        r.setFields(),
        (r.isReverseGeocode = !0),
        r
      )
    }
    return r(i)
  ...
  function Kn(t, n) {
    ...
    var a = i(this),
      r =
        0 === o.reverseGeocode.containers.length
          ? i(document)
          : a.closest(o.reverseGeocode.containers.toString())
    if (r.find('[data-afd-control="reverseGeocodeButton"]').length > 1)
    ...
    var s = r.find('[data-afd-control="reverseGeocodeResultsList"]'),
      l = r.find('[data-afd-control="reverseGeocodeResultsList"]').length
    if (0 === l)
  ...
  var Zn = function (e) {
    return (function (e) {
      ...
      function o() {
        ...
        return (
          h(
            s((e = i.call.apply(i, [this].concat(r)))),
            'handleInvalid',
            function (n) {
              var i =
                ...
                o = i ? i[0] : e.$element[0],
                a = i || e.$element
              o.setCustomValidity(n),
                !0 === e.options.nativeValidationMessages && o.reportValidity(),
                a
                ...
                a.parent().addClass('was-validated'),
                a
                  .siblings('.invalid-feedback')
                  .first()
                  .html(o.validationMessage),
                t(document).trigger('afd:validateComplete', {
                  valid: !1,
                  validationMessage: n
                })
            }
          ),
          h(s(e), 'handleValid', function () {
            var n =
            ...
            i.setCustomValidity(''),
              ...
              o.siblings('.invalid-feedback').first().html(i.validationMessage),
              t(document).trigger('afd:validateComplete', {
                valid: !0,
                validationMessage: null
              })
          }),
          h(s(e), 'clearValidation', function () {
            var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : null,
            ...
            n.setCustomValidity(''),
              ...
              i
                ...
                .closest('.iti')
                .removeClass('afd-invalid'),
              i.parent().removeClass('was-validated')
          }),
          h(s(e), 'showLoadingSpinner', function (t, e) {
            e && t.closest(e).addClass('afd-loading')
          }),
          h(s(e), 'hideLoadingSpinner', function (t, e) {
    ...
    Yn = (function (t) {
      ...
      function i(t, o) {
        ...
        return (
          n(this, i),
          h(s((a = e.call(this, t, o))), 'init', function () {
            a.$element.data('account-is-regex-valid', !1),
              a.$element.data('account-is-syntax-valid', !1),
              a.$element.data('account-is-afd-valid', !1),
              a.$sortCodeElement.data('sort-code-is-regex-valid', !1),
              a.$sortCodeElement.data('sort-code-is-syntax-valid', !1)
            var t = a.eventHandler
            t(a.$element, 'keydown', a.onKeyDown),
              t(a.$element, 'keyup', a.onKeyUp),
              t(a.$element, 'focusout', a.onFocusOut),
              t(a.$sortCodeElement, 'keydown', a.onSortKeyDown),
              t(a.$sortCodeElement, 'input', a.onSortKeyUp),
              t(a.$sortCodeElement, 'focus', a.onSortFocus),
              t(a.$sortCodeElement, 'focusout', a.onSortFocusOut),
              a.$sortCodeElement.val(a.applySortMask(''))
          }),
          h(s(a), 'onKeyDown', function (t) {
            var e = t.target,
              n = e.selectionStart
            if ('Backspace' === t.key && n > 0) {
              n -= 1
              var i = e.value.substring(0, n - 1) + e.value.substring(n)
              ;(e.value = i),
                e.setSelectionRange(n - 1, n - 1),
                t.preventDefault()
            }
          }),
          h(s(a), 'onFocusOut', function () {
            a.checkAccountSyntaxValid()
            var t = a.$element
            a.$element.val(),
              t.data('account-is-syntax-valid')
                ? a.checkBoth()
                : a.handleInvalid(a.options.account.invalidAccountNumberMessage)
          }),
          h(s(a), 'onSortKeyDown', function (t) {
            var e = t.target,
              n = e.selectionStart
            if ('Backspace' === t.key && n > 0) {
              '-' === e.value[n - 1] && (n -= 1)
              var i = e.value.substring(0, n - 1) + e.value.substring(n)
              ;(e.value = a.applySortMask(i)),
                e.setSelectionRange(n - 1, n - 1),
                t.preventDefault()
            }
          }),
          h(s(a), 'onSortKeyUp', function (t) {
            var e = t.target,
              n = e.selectionStart,
              i = t.key,
              o = a.applySortMask(e.value)
            ;(e.value = o),
              'Backspace' === i && '-' === o[n - 1]
                ? (n -= 1)
                : 'Delete' === i && '-' === o[n]
          ...
          h(s(a), 'onSortFocus', function (t) {
            var e = t.target
            Jn(e).css({ color: 'transparent', 'text-shadow': '0 0 0 #000' }),
              setTimeout(function () {
                e.setSelectionRange(0, 0),
                  Jn(e).css({ color: '', 'text-shadow': '' })
              }, 0)
          }),
          h(s(a), 'onSortFocusOut', function () {
            a.checkSortSyntaxValid()
            var t = a.$sortCodeElement
            t.data('sort-code-is-syntax-valid')
              ? a.checkBoth()
              : (a.handleInvalid(a.options.account.invalidSortCodeMessage, t),
                a.$element.data('account-is-afd-valid', !1),
                a.$element.data('account-clearing-system', null),
                a.$element.data('account-iban', null),
                a.$element.data('account-roll-number', null),
                a.$element.data('account-type', null)),
              Jn(document).trigger('afd:accountValidationUpdated', [
                a.$element.get()[0],
                t.get()[0]
              ]),
              a.$element.trigger('afd:accountValidationUpdated', [
                a.$element,
                t
              ]),
              t.trigger('afd:accountValidationUpdated', [a.$element, t])
          }),
          h(s(a), 'applySortMask', function (t) {
            for (
              var e = '99-99-99'.split('-'),
                n = '',
                i = t.replace(/\D/g, '').split(''),
                o = 0;
              o < e.length;
              o++
            ) {
              var a = e[o].length,
                r = i.splice(0, a).join('')
              r.length < a && (r += new Array(a - r.length + 1).join(' ')),
                (n += (0 !== o ? '-' : '') + r)
            }
            return n
          }),
          (a.$sortCodeElement = Jn('[data-afd-control="sort"]')),
          (a.accountPattern = /^[0-9]{8}$/),
          (a.sortCodePattern = /^[0-9]{2}-[0-9]{2}-[0-9]{2}$/),
          a
        )
      }
      return (
        r(i, [
          {
            ...
            value: function () {
              var t = this,
                e = this.$element,
                n = e.val(),
                i = e.data('account-is-syntax-valid'),
                o = this.$sortCodeElement,
                a = o.val(),
                r = o.data('sort-code-is-syntax-valid')
              i &&
                r &&
                (Jn(document).trigger('afd:accountValidationStarted', [e, o]),
                e.trigger('afd:accountValidationStarted', [e, o]),
                o.trigger('afd:accountValidationStarted', [e, o]),
                this.showLoadingSpinner(e, this.options.account.loadingSpinner),
                this.validateAccount(n, a)
                  .then(function (n, i, a) {
                    if ('1' === n.Result) {
                      var r = g(n.Item, 1)[0]
                      t.handleValid(),
                        t.handleValid(o),
                        e.data('account-is-afd-valid', !0),
                        e.data('account-clearing-system', r.ClearingSystem),
                        e.data('account-iban', r.IBAN),
                        e.data('account-roll-number', r.RollNumber),
                        e.data('account-type', r.TypeOfAccount)
                    } else
                      '-12' === n.Result || '-13' === n.Result
                        ? t.handleInvalid(n.ErrorText, o)
                        : t.handleInvalid(n.ErrorText)
                    Jn(document).trigger('afd:accountValidationSuccess', [
                      n,
                      e,
                      o,
                      a
                    ]),
                      e.trigger('afd:accountValidationSuccess', [n, e, o, a]),
                      o.trigger('afd:accountValidationSuccess', [n, e, o, a]),
                      t.hideLoadingSpinner(e, t.options.account.loadingSpinner),
                      Jn(document).trigger('afd:accountValidationUpdated', [
                        e.get()[0],
                        o.get()[0]
                      ]),
                      e.trigger('afd:accountValidationUpdated', [e, o]),
                      o.trigger('afd:accountValidationUpdated', [e, o])
                  })
                  .catch(function (n) {
                    console.error(n),
                      Jn(document).trigger('afd:accountValidationError', [n]),
                      e.trigger('afd:accountValidationError', [n]),
                      o.trigger('afd:accountValidationError', [n]),
                      t.hideLoadingSpinner(e, t.options.account.loadingSpinner)
                  }))
            }
          },
          {
            key: 'checkAccountSyntaxValid',
            value: function () {
              var t = this.$sortCodeElement,
                e = this.$element,
                n = e.val()
              0 !== n.length &&
                (this.accountPattern.test(n)
          ...
          {
            key: 'checkSortSyntaxValid',
            value: function () {
              var t = this.$sortCodeElement,
                e = this.$element,
                n = t.val()
              0 !== n.length &&
                (this.sortCodePattern.test(n)
                  ...
                  : (console.log(1),
                    ...
                    this.handleInvalid(
                      this.options.account.invalidSortCodeMessage,
                      t
                    )),
                Jn(document).trigger('afd:accountValidationUpdated', [
                  e.get()[0],
  ...
  var ti,
    ei = function (t) {
      for (var e, n = 0, i = !1, o = t.length - 1; o >= 0; )
        (e = parseInt(t.charAt(o), 10)),
          i && (e *= 2) > 9 && (e = (e % 10) + 1),
          (i = !i),
          (n += e),
          o--
    ...
    vi = [oi, ai, ri, si, li, ci, di, hi, ui, pi]
  function gi(t, e) {
    var n, i, o
    return t
      ? ((i = t.prefixPattern),
        ...
        e
          ? ((n.prefixPattern = i), (n.exactPattern = o))
          : (delete n.prefixPattern, delete n.exactPattern),
        n)
      : null
  }
  function yi(t) {
  ...
  function mi(t) {
    var e,
      ...
      i = [],
      o = []
    if (!('string' == typeof t || t instanceof String)) return []
    for (n = 0; n < ti.length; n++)
      (e = yi(ti[n])),
        0 !== t.length
          ? e.exactPattern.test(t)
            ? o.push(gi(e))
            : e.prefixPattern.test(t) && i.push(gi(e))
          : i.push(gi(e))
    return o.length ? o : i
  }
  function Ci(t, e) {
  ...
  ;(ti = gi(vi)),
    ...
    (mi.getTypeInfo = function (t) {
      return gi(yi(t))
    }),
    (mi.removeCard = function (t) {
      var e = Ci(t)
      ti.splice(e, 1)
    }),
    (mi.addCard = function (t) {
      var e = Ci(t.type, !0)
      ;(ii[t.type] = t), -1 === e && ti.push(t.type)
    }),
    (mi.updateCard = function (t, e) {
      var n,
        i = ii[t] || ni[t]
      if (!i)
        throw new Error(
          '"' + t + '" is not a recognized type. Use `addCard` instead.'
        )
      if (e.type && i.type !== e.type)
    ...
    (mi.changeOrder = function (t, e) {
      var n = Ci(t)
      ti.splice(n, 1), ti.splice(e, 0, t)
    }),
    (mi.resetModifications = function () {
      ;(ti = gi(vi)), (ii = {})
    }),
    (mi.types = {
      VISA: oi,
  ...
  var bi = mi,
    ...
    ki = bi
  function Si(t, e, n) {
    return { card: t, isPotentiallyValid: e, isValid: n }
  }
  var Ii = function (t, e) {
    var n, i, o, a, r
    if (
    ...
    if (((t = t.replace(/\-|\s/g, '')), !/^\d*$/.test(t)))
      return Si(null, !1, !1)
    if (0 === (n = ki(t)).length) return Si(null, !1, !1)
    if (1 !== n.length) return Si(null, !0, !1)
    for (
      o =
        ((i = n[0]).type === ki.types.UNIONPAY &&
          !0 !== e.luhnValidateUnionPay) ||
        wi(t),
        r = Math.max.apply(null, i.lengths),
        a = 0;
      a < i.lengths.length;
      a++
    )
      if (i.lengths[a] === t.length) return Si(i, t.length !== r || o, o)
    return Si(i, t.length < r, !1)
  }
  function Li(t, e, n) {
    return { isValid: t, isPotentiallyValid: e, isCurrentYear: n || !1 }
  }
  var xi = function (t, e) {
      var n, i, o, a, r
      return (
            ...
            : /^\d*$/.test(t)
              ? (i = t.length) < 2
                ...
                : ((n = new Date().getFullYear()),
                  3 === i
                    ? Li(!1, t.slice(0, 2) === String(n).slice(0, 2))
                    : i > 4
                      ? Li(!1, !1)
                      : ((t = parseInt(t, 10)),
                        (o = Number(String(n).substr(2, 2))),
                        2 === i
                          ? ((r = o === t), (a = t >= o && t <= o + e))
                          : 4 === i &&
                            ((r = n === t), (a = t >= n && t <= n + e)),
    ...
    Ai = _i
  function Ei(t, e, n) {
    return { isValid: t, isPotentiallyValid: e, isValidForThisYear: n || !1 }
  }
  var Fi = function (t) {
      var e,
        n,
      ...
      return 'string' != typeof t
        ...
        : '' === t.replace(/\s/g, '') || '0' === t
          ...
          : /^\d*$/.test(t)
            ? ((e = parseInt(t, 10)),
              isNaN(t) ? Ei(!1, !1) : Ei((n = e > 0 && e < 13), n, n && e >= i))
            : Ei(!1, !1)
    },
    Oi = function (t) {
      var e, n, i
      return (
        /\//.test(t)
          ? (t = t.split(/\s*\/\s*/g))
          : /\s/.test(t) && (t = t.split(/ +/g)),
        Ai(t)
          ? { month: t[0], year: t.slice(1).join() }
          : ((n = '0' === t[0] || t.length > 5 ? 2 : 1),
            '1' === t[0] &&
              ((i = t.substr(1)), Mi(i).isPotentiallyValid || (n = 2)),
            { month: (e = t.substr(0, n)), year: t.substr(e.length) })
      )
    },
    Ri = Fi,
    zi = xi
  function $i(t, e, n, i) {
    return { isValid: t, isPotentiallyValid: e, month: n, year: i }
  }
  var Ti = 3
  function Bi(t, e) {
    return { isValid: t, isPotentiallyValid: e }
  }
  function Pi(t, e) {
    return { isValid: t, isPotentiallyValid: e }
  }
  var Di = {
      number: Ii,
      expirationDate: function (t, e) {
        var n, i, o, a
        if ('string' == typeof t)
          (t = t.replace(/^(\d\d) (\d\d(\d\d)?)$/, '$1/$2')), (n = Oi(t))
        else {
          if (null === t || 'object' != typeof t) return $i(!1, !1, null, null)
          n = { month: String(t.month), year: String(t.year) }
        }
        if (((i = Ri(n.month)), (o = zi(n.year, e)), i.isValid)) {
          if (o.isCurrentYear)
            return $i((a = i.isValidForThisYear), a, n.month, n.year)
          if (o.isValid) return $i(!0, !0, n.month, n.year)
        }
        return i.isPotentiallyValid && o.isPotentiallyValid
          ? $i(!1, !0, null, null)
          : $i(!1, !1, null, null)
      },
      expirationMonth: Fi,
          ...
          'string' != typeof t
            ...
            : /^\d*$/.test(t)
              ? (function (t, e) {
                ...
                ? Bi(!0, !0)
                : t.length < Math.min.apply(null, e)
                  ? Bi(!1, !0)
                  : t.length >
                      (function (t) {
                        for (var e = Ti, n = 0; n < t.length; n++)
                          e = t[n] > e ? t[n] : e
                        return e
                      })(e)
                    ? Bi(!1, !1)
    ...
    Gi = (function (t) {
      ...
      function i(t, o) {
        ...
        return (
          n(this, i),
          h(s((a = e.call(this, t, o))), 'init', function () {
            ;(a.$expiryElement = ji('[data-afd-control="expiry"]')),
              (a.$cvvElement = ji('[data-afd-control="cvv"]')),
              a.$element.data('card-is-afd-valid', !1),
              a.$expiryElement.data('expiry-is-regex-valid', !1),
              a.$expiryElement.data('expiry-is-syntax-valid', !1)
            var t = a.eventHandler
            t(a.$element, 'keydown', a.onKeyDown),
              t(a.$element, 'keyup', a.onKeyUp),
              t(a.$element, 'focusout', a.onFocusOut),
              t(a.$expiryElement, 'keydown', a.onExpiryKeyDown),
              t(a.$expiryElement, 'keyup', a.onExpiryKeyUp),
              t(a.$expiryElement, 'focusout', a.onExpiryFocusOut),
              ji('.afd-card-logo')
                .html(Vi)
                .find('svg')
                .attr('height', a.options.card.logoHeight)
                .attr('width', a.options.card.logoWidth),
              a.$element.data('card-is-regex-valid', !1),
              a.$element.data('card-is-syntax-valid', !1),
              a.$element.data('card-is-afd-valid', !1),
              a.$element.data('card-type', ''),
              a.$element.data('card-type-nice', ''),
              a.$element.data('expiry-is-regex-valid', !1),
              a.$element.data('expiry-is-syntax-valid', !1),
              a.$cvvElement.data('code-name', ''),
              a.$cvvElement.data('code-length', ''),
              a.$cvvElement.attr('maxlength', 3)
          }),
          h(s(a), 'onKeyDown', function (t) {
            ;(t.keyCode < 48 || t.keyCode > 57) &&
              (t.keyCode < 96 || t.keyCode > 105) &&
              (t.keyCode < 112 || t.keyCode > 123) &&
              -1 === a.utilKeys.indexOf(t.keyCode) &&
              t.preventDefault()
          }),
          h(s(a), 'onKeyUp', function () {
            a.checkCardSyntaxValid().isValid
              ? a.handleValid()
              : a.clearValidation()
          }),
          h(s(a), 'onFocusOut', function () {
            a.checkCardSyntaxValid().isValid
              ? a.checkBoth()
              : a.handleInvalid(a.options.card.invalidCardNumberMessage)
          }),
          h(s(a), 'checkCardSyntaxValid', function () {
            var t = a.$element,
              e = t.val(),
              n = Di.number(e)
            if (null !== n.card) {
              t.data('card-type', n.card.type),
                t.data('card-type-nice', n.card.niceType)
              var i = Vi
              switch (n.card.type) {
                case 'visa':
                  i =
              ...
              ji('.afd-card-logo')
                ...
                .attr('width', a.options.card.logoWidth)
              var o = n.card.code
              a.$cvvElement.data('code-name', o.name),
                a.$cvvElement.data('code-length', o.size),
                a.$cvvElement.attr('maxlength', o.size)
            }
            return (
              t.data('card-is-regex-valid', n.isValid),
              t.data('card-is-syntax-valid', n.isValid),
              t.data('card-is-afd-valid', !1),
              console.log(1),
              ji(document).trigger('afd:cardValidationUpdated', [
                t,
                a.$expiryElement,
                a.$cvvElement
              ]),
              ...
              a.$expiryElement.trigger('afd:cardValidationUpdated', [
                t,
                a.$expiryElement,
                a.$cvvElement
              ]),
              a.$cvvElement.trigger('afd:cardValidationUpdated', [
                t,
                a.$expiryElement,
                a.$cvvElement
              ]),
          ...
          h(s(a), 'onExpiryKeyDown', function (t) {
            var e = a.$expiryElement,
              n = e.val()
            ;(t.keyCode < 48 || t.keyCode > 57) &&
              (t.keyCode < 96 || t.keyCode > 105) &&
              (t.keyCode < 112 || t.keyCode > 123) &&
              ...
              n.length > 9 &&
                ...
                t.preventDefault(),
              2 !== n.length ||
                Di.expirationMonth(n).isValid ||
                -1 !== [8, 46, 37, 39].indexOf(t.keyCode) ||
                t.preventDefault(),
              a.keyupVal.length > 4 &&
                a.validSeperators.indexOf(t.key) > -1 &&
                t.preventDefault(),
              5 === a.keyupVal.length &&
                8 === t.keyCode &&
                (e.val(a.keyupVal.replace(' / ', '')), t.preventDefault())
          }),
          h(s(a), 'onExpiryKeyUp', function (t) {
            var e = a.$expiryElement,
              n = e.val().replace(' ', ''),
              i = Di.expirationDate(n)
            if (i.isValid) a.handleValid(e)
            else if (1 === n.length) a.clearValidation(e)
            else if (2 === n.length) {
              var o = n.substr(0, 1),
                r = n.substr(1, 1)
              if (a.validSeperators.indexOf(r) > -1) {
                Di.expirationMonth(o).isValid
                  ? e.val('0' + o + ' / ')
                  : a.handleInvalid(a.options.card.invalidExpiryMonthMessage, e)
              } else {
                var s = Di.expirationMonth(n)
                s.isValid && 8 !== t.keyCode && 46 !== t.keyCode
                  ? e.val(n + ' / ')
                  : 8 === t.keyCode || (46 === t.keyCode && s.isValid)
                    ? a.clearValidation(e)
                    : a.handleInvalid(
                        a.options.card.invalidExpiryMonthMessage,
                        e
                      )
              }
            } else
              3 === n.length
                ? a.validSeperators.indexOf(t.key) > -1 &&
                  e.val(n.replace(t.key, ' / '))
                : a.clearValidation(e)
            ;(a.keyupVal = e.val()),
              a.$element.data('card-is-afd-valid', !1),
              e.data('expiry-is-regex-valid', i.isValid),
              e.data('expiry-is-syntax-valid', i.isValid),
              ji(document).trigger('afd:cardValidationUpdated', [
                a.$element,
                e,
                a.$cvvElement
              ]),
              a.$element.trigger('afd:cardValidationUpdated', [
                a.$element,
                e,
                a.$cvvElement
              ]),
          ...
          h(s(a), 'onExpiryFocusOut', function (t) {
            var e = a.$expiryElement,
              n = e.val().replace(' ', ''),
              i = Di.expirationDate(n)
            if (i.isValid) {
              var o = 2 === i.year.length ? '20' + i.year : i.year
              e.val(i.month + ' / ' + o), a.checkBoth()
            } else a.handleInvalid(a.options.card.invalidExpiryDateMessage, e)
            a.$element.data('card-is-afd-valid', !1),
              e.data('expiry-is-regex-valid', i.isValid),
              e.data('expiry-is-syntax-valid', i.isValid),
              ji(document).trigger('afd:cardValidationUpdated', [
          ...
          h(s(a), 'checkBoth', function () {
            var t = ji('[data-afd-control="card"]'),
              e = t.val(),
              n = Di.number(e),
              i = ji('[data-afd-control="expiry"]'),
              o = i.val().replace(' / ', '/'),
              r = Di.expirationDate(o)
            n.isValid &&
              r.isValid &&
              (ji(document).trigger('afd:cardValidationStarted', [
                t,
                i,
                a.$cvvElement
              ]),
              t.trigger('afd:cardValidationStarted', [t, i, a.$cvvElement]),
              i.trigger('afd:cardValidationStarted', [t, i, a.$cvvElement]),
              a.showLoadingSpinner(t, a.options.card.loadingSpinner),
              a
                .validateCard(e, o)
                .then(function (e) {
                  if ('1' === e.Result) {
                    ...
                    a.handleValid(),
                      a.handleValid(i),
                      t.data('card-type-nice', n.CardType),
                      ...
                      i.trigger('afd:cardValidationUpdated', [
                        t,
                        i,
                        a.$cvvElement
                      ]),
                  ...
                  ji(document).trigger('afd:cardValidationSuccess', [
                    e,
                    t,
                    i,
                    a.$cvvElement
                    ...
                    i.trigger('afd:cardValidationSuccess', [
                      e,
                      t,
                      i,
                      a.$cvvElement
                    ]),
                    a.hideLoadingSpinner(t, a.options.card.loadingSpinner)
                })
                .catch(function (e) {
                  console.error(e),
                    ji(document).trigger('afd:cardValidationError', [e]),
                    t.trigger('afd:cardValidationError', [e]),
                    i.trigger('afd:cardValidationError', [e]),
                    a.hideLoadingSpinner(t, a.options.card.loadingSpinner)
                }))
          }),
          (a.utilKeys = [37, 39, 8, 46, 111, 220, 109, 32, 9]),
          (a.validSeperators = [' ', '-', '/', '\\']),
          (a.keyupVal = ''),
          a
        )
  ...
  function Ui(t, n) {
    ...
    var r = i('[data-afd-control="expiry"]'),
      s = r.length
    if (0 === s)
  ...
  var Wi = jQuery,
    Zi = (function (t) {
      ...
      function i(t, o) {
        ...
        return (
          n(this, i),
          h(s((a = e.call(this, t, o))), 'onKeyUp', function (t) {
            var e = a.$element,
              n = e.val()
            e.data('email-is-afd-valid', !1),
              e.data('email-pce-message', 'Syntax not valid'),
              Hi(n)
                ? (e.data('email-is-regex-valid', !0),
                  e.data('email-syntax-valid', !0),
                  e.data(
                    'email-pce-message',
                    'Regex valid, not yet queried PCE'
                  ))
                : (e.data('email-is-regex-valid', !1),
                  e.data('email-syntax-valid', !1),
                  Wi(document).trigger('afd:emailValidationUpdated', [e]),
                  e.trigger('afd:emailValidationUpdated', [e])),
              a.clearValidation(),
              Wi(document).trigger('afd:emailValidationUpdated', [e]),
              e.trigger('afd:emailValidationUpdated', [e])
          }),
          h(s(a), 'onFocusOut', function () {
            void 0 === a.$element.data('afd-already-valid') &&
              a.$element.data('afd-already-valid', []),
              void 0 === a.$element.data('afd-already-invalid') &&
            ...
            if (Hi(e)) {
              if (
                ...
                a.$element.data('afd-already-valid').indexOf(e) > -1)
              )
                return (
                  a.handleValid(),
                  t.data('email-is-afd-valid', !0),
                  Wi(document).trigger('afd:emailValidationUpdated', [t]),
                  Wi(document).trigger('afd:emailValidationUpdatedFocusOut', [
                    t
                  ]),
                  t.trigger('afd:emailValidationUpdated', [t]),
                  void t.trigger('afd:emailValidationUpdatedFocusOut', [t])
                )
              if (a.$element.data('afd-already-invalid').indexOf(e) > -1)
                return (
                  a.handleInvalid(a.options.email.invalidEmailMessage),
              ...
              Wi(document).trigger('afd:emailValidationStarted', [t]),
                t.trigger('afd:emailValidationStarted', [t]),
                a.showLoadingSpinner(t, a.options.email.loadingSpinner),
                a
                  .validateEmail(e)
                  .then(function (n, i, o) {
                    if ('1' === n.Result) {
                      ...
                      a.handleValid(),
                        t.data('email-is-afd-valid', !0),
                        t.data('email-pce-message', r.Status),
                        Wi(document).trigger('afd:emailValidationUpdated', [t]),
                        Wi(document).trigger(
                      ...
                      var s = a.$element.data('afd-already-valid')
                      s.indexOf(e) < 0 &&
                        (s.push(e), a.$element.data('afd-already-valid', s))
                    } else if ('-2' === n.Result) {
                      a.handleInvalid(a.options.email.invalidEmailMessage),
                        t.data('email-is-afd-valid', !1),
                        t.data('email-pce-message', n.ErrorText),
                        Wi(document).trigger('afd:emailValidationUpdated', [t]),
                        Wi(document).trigger(
                          'afd:emailValidationUpdatedFocusOut',
                          [t]
                        ...
                        t.trigger('afd:emailValidationUpdated', [t]),
                        t.trigger('afd:emailValidationUpdatedFocusOut', [t])
                      var l = a.$element.data('afd-already-invalid')
                      l.indexOf(e) < 0 &&
                        (l.push(e), a.$element.data('afd-already-invalid', l))
                    } else
                      a.clearValidation(),
                        t.data('email-is-afd-valid', !1),
                        t.data('email-pce-message', n.Result),
                        Wi(document).trigger('afd:emailValidationUpdated', [t]),
                        Wi(document).trigger(
                          'afd:emailValidationUpdatedFocusOut',
                          [t]
                        ...
                        t.trigger('afd:emailValidationUpdated', [t]),
                        t.trigger('afd:emailValidationUpdatedFocusOut', [t])
                    Wi(document).trigger('afd:emailValidationSuccess', [
                      n,
                      t,
                      o
                    ]),
                      t.trigger('afd:emailValidationSuccess', [n, t, o]),
                      a.hideLoadingSpinner(t, a.options.email.loadingSpinner)
                  })
                  .fail(function (e) {
                    console.error(e),
                      Wi(document).trigger('afd:emailValidationError', [e]),
                      a.hideLoadingSpinner(t, a.options.email.loadingSpinner)
                  })
            } else
              t.data('email-is-regex-valid', !1),
                ...
                a.handleInvalid(a.options.email.invalidEmailMessage),
                Wi(document).trigger('afd:emailValidationUpdatedFocusOut', [t]),
                Wi(document).trigger('afd:emailValidationUpdated', [t]),
                t.trigger('afd:emailValidationUpdated', [t]),
                t.trigger('afd:emailValidationUpdatedFocusOut', [t])
            Wi(document).trigger('afd:emailValidationUpdated', [t]),
          ...
          h(s(a), 'validateEmail', function (t) {
            var e = {
              data: 'email',
              task: a.options.email.task,
              fields: 'standard',
              email: t,
              afdc: a.options.afdc
            }
            e = Wi.extend(e, a.options.email.additionalPCEParams)
            var n = a.setupParams(e)
            return Wi.ajax(n)
          }),
          (a.controlType = 'email'),
              ...
              (a = [
                ...
                },
                {
                  ...
                  value: function (e, n, i) {
                    ...
                    var a = i !== t ? i : this.countryCodes[n].length
                    this.countryCodes[n][a] = e
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    for (var n = 0; n < this.countries.length; n++) {
                      ...
                      if (i.areaCodes)
                        for (
                          var o = this.countryCodes[i.dialCode][0], a = 0;
                          a < i.areaCodes.length;
                          a++
                        ) {
                          for (
                            var r = i.areaCodes[a], s = 1;
                            s < r.length;
                            s++
                          ) {
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      if (i) {
                        var o = i.lastIndexOf('[')
                        ;-1 !== o &&
                          (n = ''.concat(i.substr(0, o), '[').concat(n, ']'))
                      }
                ...
                },
                {
                  ...
                  value: function (t, e, n) {
                    n && !t.classList.contains(e)
                      ? t.classList.add(e)
                      : !n && t.classList.contains(e) && t.classList.remove(e)
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function (t, n, i) {
                    for (
                      var o = n ? e : this.countries, a = 0;
                      a < o.length;
                      a++
                    )
                      if (o[a].iso2 === t) return o[a]
                    if (i) return null
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      if (
                        (a &&
                          (a.classList.remove('iti__active'),
  ...
  var to = jQuery,
    eo = (function (t) {
      ...
      function i(t, o) {
        ...
        return (
          n(this, i),
          h(s((a = e.call(this, t, o))), 'onKeyUp', function () {
            var t = a.$element,
              e = a.$element.val()
            a.$element.val().startsWith('00') && (e = e.replace('00', '+')),
              a.$element.val(e),
              a.updateDataAttributes(),
              t.data('phone-is-afd-valid', !1),
              a.clearValidation(),
              a.iti.isValidNumber() && a.iti.setNumber(a.iti.getNumber('2')),
              to(document).trigger('afd:phoneValidationUpdated', [t])
          }),
          h(s(a), 'onFocusOut', function () {
            void 0 === a.$element.data('afd-already-valid') &&
              a.$element.data('afd-already-valid', []),
              void 0 === a.$element.data('afd-already-invalid') &&
                a.$element.data('afd-already-invalid', [])
            var t = a.$element
            if (a.iti.isValidNumber()) {
              if (
                a.$element
                  .data('afd-already-valid')
                  .indexOf(a.iti.getNumber()) > -1
              )
                return (
                  a.handleValid(),
                  t.data('phone-is-afd-valid', !0),
                  void to(document).trigger('afd:phoneValidationUpdated', [t])
                )
              if (
                a.$element
              ...
              to(document).trigger('afd:phoneValidationStarted', [t]),
                a.showLoadingSpinner(t, a.options.phone.loadingSpinner),
                a
                  .validatePhone(a.iti.getNumber(), a.countryData.iso3)
                  .done(function (e, n, i) {
                    if ('1' === e.Result) {
                      a.handleValid(),
                        t.data('phone-is-afd-valid', !0),
                        to(document).trigger('afd:phoneValidationUpdated', [t])
                      var o = a.$element.data('afd-already-valid')
                      o.indexOf(a.iti.getNumber()) < 0 &&
                        (o.push(a.iti.getNumber()),
                        a.$element.data('afd-already-valid', o))
                    } else if ('-2' === e.Result) {
                      a.handleInvalid(
                        a.options.phone.invalidPhoneNumberMessage
                      ),
                        t.data('phone-is-afd-valid', !1),
                        to(document).trigger('afd:phoneValidationUpdated', [t])
                      var r = a.$element.data('afd-already-invalid')
                      r.indexOf(a.iti.getNumber()) < 0 &&
                        (r.push(a.iti.getNumber()),
                        a.$element.data('afd-already-invalid', r))
                    } else
                      -7 === e.Result &&
                        (console.error(
                          'Unable to validate phone number using AFD PCE, data licence error'
                        ),
                        t.data('phone-is-afd-valid', !0),
                        to(document).trigger('afd:phoneValidationUpdated', [t]))
                    to(document).trigger('afd:phoneValidationSuccess', [
                      e,
                      t,
                      i
                    ]),
                      a.hideLoadingSpinner(t, a.options.phone.loadingSpinner)
                  })
                  .fail(function (e) {
                    console.error(e),
                      to(document).trigger('afd:phoneValidationError', [e]),
                      a.hideLoadingSpinner(t, a.options.phone.loadingSpinner)
                  })
            } else
              a.handleInvalid(a.options.phone.invalidPhoneNumberMessage),
                t.data('phone-is-afd-valid', !1),
                to(document).trigger('afd:phoneValidationUpdated', [a.$element])
          }),
          h(s(a), 'onCountryChange', function () {
            var t = a.$element,
              e = t.val()
            ;(a.countryData = a.iti.getSelectedCountryData()),
              void 0 !== a.countryData.iso2 &&
                (a.countryData.iso3 = a.iso2ToIso3(
                  a.countryData.iso2.toUpperCase()
                )),
              void 0 !== a.countryData.dialCode &&
                e.startsWith('+') &&
                (e = e.replace('+' + a.countryData.dialCode, '')),
              a.$element.val(e),
              a.updateDataAttributes(),
              to(document).trigger('afd:phoneValidationUpdated', [t])
          }),
          h(s(a), 'onCountryControlChange', function (t) {
            var e = a.options.phone.countryControlConverter
              ? a.options.phone.countryControlConverter(t, a.iso2ToIso3)
              : a.formatCountryISO2(t.target.value)
            a.iti.setCountry(e)
          }),
          h(s(a), 'formatCountryISO2', function (t) {
            if ([2, 3].indexOf(t.length) < 0)
              throw 'Value of country field should be either ISO2 or ISo3 format'
            return (t =
              2 === t.length ? t.toLowerCase() : iso3ToIso2(t).toLowerCase())
          }),
          h(s(a), 'setCountryDialingCode', function (t, e) {
            return '+' !== t.substr(0, 1) && t.substr(0, !0) ? e + t : t
          }),
          h(s(a), 'updateDataAttributes', function () {
            var t = a.$element,
              e = a.iti.getNumberType()
            t.data('phone-is-regex-valid', a.iti.isValidNumber()),
              t.data('phone-is-syntax-valid', a.iti.isValidNumber()),
              t.data('phone-syntax-valid', a.iti.isValidNumber()),
              t.data(
                'phone-region-name',
                void 0 !== a.countryData.name ? a.countryData.name : ''
              ),
              t.data(
                'phone-region',
                void 0 !== a.countryData.iso2
              ...
              t.data(
                'phone-region-iso3',
                void 0 !== a.countryData.iso3 ? a.countryData.iso3 : ''
              ),
              t.data('phone-number', a.iti.getNumber()),
              t.data('phone-number-e164', a.iti.getNumber()),
              t.data('phone-number-international', a.iti.getNumber(1)),
              t.data('phone-number-national', a.iti.getNumber(2)),
              t.data('phone-number-rfc3966', a.iti.getNumber(3))
            var n = [
              'FIXED_LINE',
              'MOBILE',
            ...
            t.data('phone-is-mobile', e > -1 && 'MOBILE' === n[e]),
              t.data('phone-is-landline', e > -1 && 'FIXED_LINE' === n[e]),
              t.data('phone-number-type', e > -1 ? n[e] : 'UNKNOWN')
          }),
          (a.controlType = 'phone'),
          a
        )
        ...
        r(i, [
          {
            ...
            value: function () {
              this.$element.data('phone-is-afd-valid', !1),
                (this.countryControl = to(this.options.phone.countryControl)),
                this.countryControl &&
                  0 === this.countryControl.length &&
                  console.warn(
                    'Country control `' +
              ...
              t(this.$element, 'keyup', this.onKeyUp),
                t(this.$element, 'focusout', this.onFocusOut),
                t(this.countryControl, 'change', this.onCountryControlChange),
                t(this.$element, 'countrychange', this.onCountryChange)
              var e = this.$element.val()
              ;(this.iti = Yi(this.element, {
                utilsScript:
                  'https://cdn.afd.co.uk/plugins/shared/phone/17.0.21/utils.js',
                separateDialCode: !0
              })),
                this.$element.val(e),
          ...
          },
          {
            key: 'validatePhone',
            value: function (t, e) {
              to(document).trigger('afd:phoneValidationStared', this.$element)
              var n = this.setupParams({
                phone: t,
                data: 'phone',
                task: 'full',
  ...
  function no(t, n) {
    ...
    void 0 !== n
      ? (o = n)
      : 'undefined' != typeof afdOptions && (o = afdOptions),
      (o = i.extend(!0, {}, e, o))
    var a = i(this)
    if (!a.is('input'))
      throw (
  ...
  var io = function (t, e) {
    for (var n = -1, i = null == t ? 0 : t.length, o = 0, a = []; ++n < i; ) {
      var r = t[n]
      e(r, n, t) && (a[o++] = r)
    }
    return a
  ...
  var oo = (function (t) {
    return function (e, n, i) {
      for (var o = -1, a = Object(e), r = i(e), s = r.length; s--; ) {
        var l = r[t ? s : ++o]
  ...
  ;(po['[object Float32Array]'] =
    ...
    (po['[object Arguments]'] =
      ...
      po['[object WeakMap]'] =
        !1)
  var fo = function (t) {
      return ho(t) && co(t.length) && !!po[uo(t)]
    },
    vo = En,
    go = On && On.isTypedArray,
    yo = go ? vo(go) : fo,
    mo = ao,
    Co = De,
    bo = w,
  ...
  var _o = function (t) {
    ...
    return t === (('function' == typeof e && e.prototype) || xo)
  }
  var Mo = (function (t, e) {
      return function (n) {
        return t(e(n))
  ...
  var Oo = Y,
    Ro = je
  var zo = function (t) {
      return null != t && Ro(t.length) && !Oo(t)
    },
    $o = Lo,
    To = function (t) {
      if (!Ao(t)) return Eo(t)
      var e = []
      for (var n in Object(t)) Fo.call(t, n) && 'constructor' != n && e.push(n)
      return e
    },
    Bo = zo
  var Po = function (t) {
      return Bo(t) ? $o(t) : To(t)
    },
    Do = oo,
    Vo = Po
  var No = zo
  var jo = (function (t, e) {
    return function (n, i) {
      if (null == n) return n
      if (!No(n)) return t(n, i)
      for (
        var o = n.length, a = e ? o : -1, r = Object(n);
        (e ? a-- : ++a < o) && !1 !== i(r[a], a, r);
  ...
  ;(ta.prototype.clear = Zo),
    (ta.prototype.delete = Qo),
    (ta.prototype.get = Jo),
    (ta.prototype.has = Yo),
    (ta.prototype.set = Xo)
  var ea = ta
  ...
  function aa(t) {
    var e = -1,
      n = null == t ? 0 : t.length
    for (this.__data__ = new na(); ++e < n; ) this.add(t[e])
  }
  ;(aa.prototype.add = aa.prototype.push = ia), (aa.prototype.has = oa)
  var ra = aa,
    sa = function (t, e) {
  ...
  var ua = function (t, e, n, i, o, a) {
    ...
    for (a.set(t, e), a.set(e, t); ++d < s; ) {
      var f = t[d],
        v = e[d]
      if (i) var g = r ? i(v, f, d, e, t, a) : i(f, v, d, t, e, a)
      if (void 0 !== g) {
        if (g) continue
        h = !1
        break
      ...
      if (p) {
        if (
          !sa(e, function (t, e) {
            if (!la(p, e) && (f === t || o(f, t, n, i, a))) return p.push(e)
          })
        ) {
          h = !1
          break
        }
      } else if (f !== v && !o(f, v, n, i, a)) {
        h = !1
        break
      }
    }
  ...
  var ca = L.Uint8Array,
    ...
    va = x ? x.prototype : void 0,
    ga = va ? va.valueOf : void 0
  var ya = function (t, e, n, i, o, a, r) {
    switch (n) {
      ...
      case '[object ArrayBuffer]':
        return !(t.byteLength != e.byteLength || !a(new ca(t), new ca(e)))
      case '[object Boolean]':
      case '[object Date]':
      case '[object Number]':
        return da(+t, +e)
      ...
      case '[object Set]':
        var l = 1 & i
        if ((s || (s = fa), t.size != e.size && !l)) return !1
        var u = r.get(t)
        if (u) return u == e
        ;(i |= 2), r.set(t, e)
        var c = ha(s(t), s(e), i, o, a, r)
        return r.delete(t), c
      case '[object Symbol]':
  ...
  var Ea = ea,
    Fa = ua,
    Oa = ya,
    Ra = function (t, e, n, i, o, a) {
      var r = 1 & n,
        s = Ma(t),
        l = s.length
      if (l != Ma(e).length && !r) return !1
      for (var u = l; u--; ) {
        var c = s[u]
        if (!(r ? c in e : Aa.call(e, c))) return !1
      }
      var d = a.get(t),
        h = a.get(e)
      ...
      for (var f = r; ++u < l; ) {
        var v = t[(c = s[u])],
          g = e[c]
        if (i) var y = r ? i(g, v, c, e, t, a) : i(v, g, c, t, e, a)
        if (!(void 0 === y ? v === g || o(v, g, n, i, a) : y)) {
          p = !1
          break
        }
        f || (f = 'constructor' == c)
  ...
  var ja = function (t, e, n, i, o, a) {
      ...
      if (h && !c)
        return (
          a || (a = new Ea()),
          r || Ba(t) ? Fa(t, e, n, i, o, a) : Oa(t, e, l, n, i, o, a)
        )
      if (!(1 & n)) {
        var p = c && Na.call(t, '__wrapped__'),
          f = d && Na.call(e, '__wrapped__')
        if (p || f) {
          var v = p ? t.value() : t,
            g = f ? e.value() : e
          return a || (a = new Ea()), o(v, g, n, i, a)
        }
      }
      return !!h && (a || (a = new Ea()), Ra(t, e, n, i, o, a))
    },
    Ga = D
  var Ua = function t(e, n, i, o, a) {
      return (
        e === n ||
        (null == e || null == n || (!Ga(e) && !Ga(n))
          ? e != e && n != n
          : ja(e, n, i, o, t, a))
      )
    },
    ...
    Ya = function (t, e, n, i) {
      ...
      for (; ++o < a; ) {
        ...
        if (r && s[2]) {
          ...
          var d = new qa()
          if (i) var h = i(u, c, l, t, e, d)
          if (!(void 0 === h ? Ha(c, u, 3, i, d) : h)) return !1
        }
      }
      return !0
    },
    Xa = function (t) {
      for (var e = Qa(t), n = e.length; n--; ) {
        var i = e[n],
          o = t[i]
        e[n] = [i, o, Za(o)]
      }
  ...
  var vr = function (t) {
    ...
    gr = function (t, e) {
      return rr(t) && sr(e)
        ...
        : function (n) {
            var i = or(n, t)
            return void 0 === i && i === e ? ar(n, t) : ir(e, i, 3)
          }
    },
    yr = function (t) {
      return t
  ...
  var br = io,
    ...
    Sr = w
  var Ir = m(function (t, e) {
    return (Sr(t) ? br : wr)(t, kr(e))
  })
  function Lr(t) {
    var e = (function () {
      if ('undefined' == typeof Reflect || !Reflect.construct) return !1
      ...
      t(e).on('load', function () {}),
        (v.prototype = {
          ...
          _setPreferredCountries: function () {
            var e = this
            ;(this.preferredCountries = []),
              t.each(this.options.preferredCountries, function (t, n) {
          ...
          _translateCountriesByLocale() {
            for (let t = 0; t < this.countries.length; t++) {
              ...
              this.options.localizedCountries.hasOwnProperty(e) &&
                (this.countries[t].name = this.options.localizedCountries[e])
            }
          },
          _countryNameSort: (t, e) => t.name.localeCompare(e.name),
          _generateMarkup: function () {
            this.countryInput = t(this.element)
            var n = 'country-select'
            this.options.defaultStyling &&
              (n += ' ' + this.options.defaultStyling),
              this.countryInput.wrap(t('<div>', { class: n }))
            var i = t('<div>', { class: 'flag-dropdown' }).insertAfter(
                this.countryInput
              ),
              o = t('<div>', { class: 'selected-flag' }).appendTo(i)
            ;(this.selectedFlagInner = t('<div>', { class: 'flag' }).appendTo(
              o
            )),
              t('<div>', { class: 'arrow' }).appendTo(o),
          ...
          _appendListItems: function (e, n) {
            ...
            t.each(e, function (t, e) {
              ;(i +=
                ...
                e.iso2 +
                '">'),
                (i += '<div class="flag ' + e.iso2 + '"></div>'),
                (i += '<span class="country-name">' + e.name + '</span>'),
                (i += '</li>')
            }),
          ...
          _setInitialState: function () {
            ...
            var e,
              n = this.countryCodeInput.val()
            n && this.selectCountry(n),
              t ||
                ((this.options.defaultCountry &&
                  (e = this._getCountryData(
                    this.options.defaultCountry,
                    !1
                  ))) ||
                  (e = this.preferredCountries.length
          ...
          _initListeners: function () {
            ...
            this.countryInput.on('keyup' + this.ns, function () {
              ...
              this.selectedFlagInner
                .parent()
                .on('click' + this.ns, function (e) {
                  t.countryList.hasClass('hide') &&
                    !t.countryInput.prop('disabled') &&
                    t._showDropdown()
                }),
              this.countryInput.on('blur' + this.ns, function () {
                t.countryInput.val() != t.getSelectedCountryData().name &&
                  t.setCountry(t.countryInput.val()),
                  t.countryInput.val(t.getSelectedCountryData().name)
              })
          },
          ...
          _loadAutoCountry: function () {
            t.fn[o].autoCountry
              ? this.handleAutoCountry()
              : t.fn[o].startedLoadingAutoCountry ||
                ((t.fn[o].startedLoadingAutoCountry = !0),
                'function' == typeof this.options.geoIpLookup &&
                  this.options.geoIpLookup(function (e) {
                    ;(t.fn[o].autoCountry = e.toLowerCase()),
                      setTimeout(function () {
                        t('.country-select input').countrySelect(
                          'handleAutoCountry'
                        )
                      })
                  }))
          ...
          _setDropdownPosition: function () {
            var n = this.countryInput.offset().top,
              ...
              r = !o && a ? '-' + (this.dropdownHeight - 1) + 'px' : ''
          ...
          _bindDropdownListeners: function () {
            ...
            t('html').on('click' + this.ns, function (t) {
              t.preventDefault(), i || e._closeDropdown(), (i = !1)
            }),
                ...
                t.preventDefault(),
                  t.which == s || t.which == l
                    ...
                    : t.which == u
                      ...
                      : t.which == c
                        ? e._closeDropdown()
                        : (t.which >= p && t.which <= f) || t.which === h
                          ? ((e.typedLetters += String.fromCharCode(t.which)),
                            e._filterCountries(e.typedLetters))
                          : t.which === d &&
                            ((e.typedLetters = e.typedLetters.slice(0, -1)),
                            e._filterCountries(e.typedLetters))
              })
          },
          _handleUpDownKey: function (t) {
            var e = this.countryList.children('.highlight').first(),
              n = t == s ? e.prev() : e.next()
            n.length &&
              (n.hasClass('divider') && (n = t == s ? n.prev() : n.next()),
          ...
          _filterCountries: function (e) {
            var n = this.countryListItems.filter(function () {
              return (
                0 === t(this).text().toUpperCase().indexOf(e) &&
                !t(this).hasClass('preferred')
              )
            })
            if (n.length) {
              var i,
              ...
              ;(i =
                o && o.next() && 0 === o.next().text().toUpperCase().indexOf(e)
                  ? o.next()
                  : n.first()),
            ...
            if (n) {
              ...
              if (n.length <= 2)
                for (var a = 0; a < this.countries.length; a++)
                  this.countries[a].iso2.match(o) &&
                    i.push(this.countries[a].iso2)
              if (0 == i.length)
                for (a = 0; a < this.countries.length; a++)
                  this.countries[a].name.match(o) &&
                    i.push(this.countries[a].iso2)
              var r = !1
              return (
                t.each(i, function (t, n) {
                  e.selectedFlagInner.hasClass(n) && (r = !0)
                }),
                r ||
          ...
          _getCountryData: function (t, e) {
            for (var n = e ? g : this.countries, i = 0; i < n.length; i++)
          ...
          handleAutoCountry: function () {
            'auto' === this.options.initialCountry &&
              ((this.defaultCountry = t.fn[o].autoCountry),
          ...
          selectCountry: function (t) {
            ;(t = t.toLowerCase()),
              this.selectedFlagInner.hasClass(t) ||
                (this._selectFlag(t), this._updateName(t))
          },
          ...
          return e === i || 'object' == typeof e
            ? this.each(function () {
                t.data(this, 'plugin_' + o) ||
                  t.data(this, 'plugin_' + o, new v(this, e))
              })
            : 'string' == typeof e && '_' !== e[0] && 'init' !== e
              ? (this.each(function () {
                  ...
                  i instanceof v &&
                    'function' == typeof i[e] &&
                    (n = i[e].apply(i, Array.prototype.slice.call(a, 1))),
        ...
        (t.fn[o].setCountryData = function (t) {
          g = t
        })
      var g = t.each(
        [
  ...
  var xr = jQuery,
    _r = (function (t) {
      ...
      function i(t, o) {
        ...
        return (
          n(this, i),
          h(s((a = e.call(this, t, o))), 'getCountries', function () {
            var t
            xr(document).trigger('afd:getCountriesStart')
            ...
            return xr.ajax(n).done(a.handleGetCountries.bind(null, t)), e
          }),
          h(s(a), 'handleGetCountries', function (t, e) {
            if (-2 === e.status) {
              var n = void 0 !== e.reason ? e.reason : ''
              throw (n += void 0 !== e.other ? ' - ' + e.other : '')
            }
            var i = e.Item,
              o = a.options.country.preferredCountries
            xr.each(o, function (t, e) {
              var n = Ir(i, { iso: e })
              if (0 !== n.length) {
                var o = n[0]
                a.$element.append(xr('<option />').val(o.iso).text(o.name))
              } else
                console.warn(
                  e +
                    ' was supplied as a preferredCountry but is not a valid option.  Please use a valid country ISO3'
                )
            })
            var r = []
            if ('SELECT' === a.$element[0].tagName)
              xr.each(i, function (t, e) {
                o.indexOf(e.iso) > -1 ||
                  (((a.options.typeahead.availableCountries.length > 0 &&
                    a.options.typeahead.availableCountries.indexOf(e.iso) >
                      -1) ||
                    (a.options.country.availableCountries.length > 0 &&
                      a.options.country.availableCountries.indexOf(e.iso) >
                        -1) ||
                    (a.options.typeahead.availableCountries.length < 1 &&
                      a.options.country.availableCountries.length < 1)) &&
                    (a.$element.append(
                      xr('<option />').val(e.iso).text(e.name)
                    ),
                    r.push(a.iso3ToIso2(e.iso))),
                  a.options.defaultCountry &&
                    (a.$element.val(a.options.defaultCountry),
                    a.$element.trigger('afd:countryChanged', [
                      a.$element.val()
                    ])),
                  a.options.country.defaultCountry &&
                    (a.$element.val(a.options.country.defaultCountry),
                    a.$element.trigger('afd:countryChanged', [
                      a.$element.val()
                    ])))
              })
              ...
              var s = []
              xr.each(o, function (t, e) {
                s.push(a.iso3ToIso2(e).toLowerCase())
              }),
                a.$element.countrySelect({
                  defaultCountry: a
                    .iso3ToIso2(a.options.country.defaultCountry)
                    .toLowerCase(),
                  onlyCountries: r,
                  preferredCountries: s
                })
            }
            xr(document).trigger('afd:getCountriesComplete', i), t()
          }),
          a
        )
      }
  ...
  function Mr(t, n, i) {
    var o = jQuery,
      ...
      r = {}
    if (
      ('undefined' != typeof afdOptions && (r = afdOptions),
      (r = o.extend(!0, {}, e, r)),
      -1 === ['SELECT', 'INPUT'].indexOf(a.prop('tagName')))
    )
      throw 'Country control should be either INPUT or SELECT'
    try {
      new _r(a, r).init().then(function () {
        i()
      })
    } catch (t) {
      console.error('Error initialising country control'), console.error(t)
    }
  }
  var Ar =
    ...
    Fr = '<div class="afd-search-again" style="display:none">Search Again</div>'
  var Or = jQuery,
    Rr = function (t) {
      ;[
        [
          'lookup.field',
          '<input class="form-control" data-afd-control="lookupField" name="tiger" id="lookup-field" placeholder="Postcode Lookup">',
          'Lookup Field'
        ],
        [
          'lookup.button',
          '<button data-afd-control="lookupButton">Lookup</button>',
          'Lookup Button'
        ],
        [
          'lookup.result',
          '<select class="custom-select" data-afd-control="lookupResultsList" multiple="yes"></select>',
          'Lookup Result'
        ],
        ['lookup.searchAgain', Fr, 'Lookup Search Again'],
        ['lookup.manualInput', Ar, 'Lookup Manual Input'],
        ['lookup.manualInputSearch', Er, 'Lookup Manual Input Search'],
        [
          'typeahead.field',
          '<div class="afd-typeahead-container afd-form-control form-group"><div class="afd-typeahead-field"><div class="afd-typeahead-query"><input class="form-control" placeholder="Start typing your address" type="search" autocomplete="off" data-afd-control="typeahead" name="lion"></div></div></div>',
          'Typeahead Field'
        ],
        ['typeahead.searchAgain', Fr, 'Typeahead Search Again'],
        ['typeahead.manualInput', Ar, 'Typeahead Manual Input'],
        ['typeahead.manualInputSearch', Er, 'Typeahead Manual Input Search']
      ].forEach(function (e) {
        var n = e[0]
        if (tn(t, n)) {
          var i = sn(t, n),
            o = tn(i, 'template') ? Or(i.template) : Or(e[1])
          tn(t, n + '.text') && o.text(sn(t, n + '.text')),
            (void 0 !== t.formContainers
              ? Or(t.formContainers)
              : Or(document)
            ).each(function (t, n) {
              zr(o.clone(), i, e[2], Or(n))
            })
        }
      })
      ;['email', 'phone', 'account', 'sort', 'card', 'expiry'].forEach(
        function (e) {
          if (tn(t, e)) {
            var n = Or(sn(t, e + '.selector'))
            n.attr('data-afd-control', e),
              tn(t, e + '.additionalOptions') &&
                n.attr(
                  'data-afd-additional-options',
                  sn(t, e + '.additionalOptions')
                )
          }
        }
      ),
        tn(t, 'results') &&
          t.results.forEach(function (t) {
            Or(t[0]).attr('data-afd-result', t[1])
          })
    },
    zr = function (t, e, n, i) {
      if (
        (tn(e, 'classes') && t.addClass(e.classes), tn(e, 'containerTemplate'))
      ) {
        var o = tn(e, 'containerAction') ? e.containerAction : 'after',
          a = Or(e.containerTemplate)
        a.filter(e.containerSelector).length > 0
          ? a[o](t)
          : a.find(e.containerSelector)[e.containerAction](t),
          $r(a, i.find(e.selector), n, e.action)
      } else $r(t, i.find(e.selector), n, e.action)
    },
    $r = function (t, e, n) {
      e[
        arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 'after'
      ](t)
    }
  function Tr(t, e, n) {
    try {
  ...
  ;(window.afdInitScripts =
    void 0 === window.afdInitScripts
      ...
      : window.afdInitScripts),
    (window.afdInitScripts.lookupButton =
      void 0 !== Tn
        ? Tn
        : window.afdInitScripts.lookupButton
          ? window.afdInitScripts.lookupButton
          : null),
    (window.afdInitScripts.typeahead =
      void 0 !== jn
        ? jn
        : window.afdInitScripts.typeahead
          ? window.afdInitScripts.typeahead
          : null),
    (window.afdInitScripts.reverseGeocodeButton =
      void 0 !== Kn
        ? Kn
        : window.afdInitScripts.reverseGeocodeButton
          ? window.afdInitScripts.reverseGeocodeButton
          : null),
    (window.afdInitScripts.account =
      void 0 !== Xn
        ? Xn
        : window.afdInitScripts.account
          ? window.afdInitScripts.account
          : null),
    (window.afdInitScripts.card =
      void 0 !== Ui
        ? Ui
        : window.afdInitScripts.card
          ? i(window.afdInitScripts.card)
          : null),
    (window.afdInitScripts.email =
      void 0 !== Qi
        ? Qi
        : window.afdInitScripts.email
          ? window.afdInitScripts.email
          : null),
    (window.afdInitScripts.phone =
      void 0 !== no
        ? no
        : window.afdInitScripts.phone
          ? window.afdInitScripts.phone
          : null),
    (window.afdInitScripts.country =
      void 0 !== Mr
        ? Mr
        : window.afdInitScripts.country
          ? window.afdInitScripts.country
          : null),
    (function (t) {
      ;(t.fn.afd = function (e, n, i) {
        return this.each(function () {
          t(this).attr('data-afd-control', e)
          var o = [
            'lookupField',
            'lookupResultsList',
          ...
          if (!(o.indexOf(e) > -1)) {
            ...
            return (
              ...
              (function (t, e, n, i) {
                try {
                  window.afdInitScripts[e].call(t, e, n, i)
                } catch (t) {
        ...
        (function (t) {
          void 0 === window.afdDataInit && (window.afdDataInit = !1),
            t(document).ready(function () {
              window.afdDataInit ||
                ((window.afdDataInit = !0),
                t(document).trigger('afd::page_ready'))
            }),
            t(document)
              .off('afd::page_ready')
              .on('afd::page_ready', function () {
                var e = ['country'],
                  n = []
                t('[data-afd-control]').each(function () {
                  var i = t(this),
                    o = i.data('afd-control')
                  e.indexOf(o) > -1 &&
                    n.push(
                  ...
                  Promise.all(n).then(function () {
                    t('[data-afd-control]').each(function () {
                      var n = t(this),
                        i = n.data('afd-control')
                      ;-1 === e.indexOf(i) && Tr(n, i, null)
                    })
                  })
              })
        })(t),
        void 0 !== Rr &&
          (t(document).ready(function () {
            afdOptions.postRender.preventAutoInit ||
              t(document).trigger('afd::initPostRender')
          }),
          t(document).on('afd::initPostRender', function () {
            try {
              if (void 0 === afdOptions.postRender)
                throw 'Post Render version of plugin used but no post render options supplied'
              Rr(afdOptions.postRender),
                t(document).trigger('afd:postRenderInitComplete')
            } catch (t) {
              console.error(t)
            }
            t(document).trigger('afd::page_ready')
