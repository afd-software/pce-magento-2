        ...
        getConfig: function(setting) {
            ...
            if(window.checkoutConfig) {
                ...
                var options = {
                    ...
                    manualEntryCss: ".afd-manual-input-button, .afd-manual-input-search-button{margin-left: 30px; padding-top: 8px; cursor: pointer; color: #1979c3;}.afd-manual-input-button{ padding-left: 11px;}",
                    manualEntryMarkup: "Manually enter address",
                    manualEntrySearchMarkup: "Search for address",
                    placeholder: "Start typing your address",
                    searchAgainCss: ".afd-search-again{margin-left: 30px; padding-top: 8px;cursor: pointer;color: #1979c3;}",
