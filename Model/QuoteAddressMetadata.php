<?php
/**
 * AFD PCE Quote Address Metadata Model
 *
 * @category    Afd
 * @package     Afd_Pce
 */
 ...
 * 
 * Model for Quote Address Metadata
 * Using a JSON-based approach for flexible metadata storage
 */
class QuoteAddressMetadata extends AbstractModel implements AddressMetadataInterface
{
    /**
     * @var Json
     */
    ...
    {
        $this->_init(ResourceModel\QuoteAddressMetadata::class);
    ...
    /**
     * Get Parent ID (Quote Address ID)
     *
     * @return int|null
     */
